'Bauanleitung für eine Datenbank wie `//LINUX/haerzte` vom 11.10.10 08:23:45
Option Explicit
...
Dim Str(1, 35, 20) As new CString, ArtZ&(3, 35)
...
Sub FüllStr4()
 ...
 Str(0, 4, 10) = "`idarzt`"
 Str(0, 4, 11) = "`lanr`"
 Str(0, 4, 12) = "`fk_arzt_titel1`"
 Str(0, 4, 13) = "`fk_arzt_nlart1`"
 Str(0, 4, 14) = "`namen`"
 Str(0, 4, 15) = "`fk_arzt_nlart1`"
 Str(0, 4, 16) = "`fk_arzt_titel1`"
 ArtZ(0, 4) = 9
 ArtZ(1, 4) = 5
 ArtZ(2, 4) = 2
 ...
 Str(1, 4, 5) = " `Namenszusatz` varchar(10) COLLATE latin1_german2_ci DEFAULT NULL"
 ...
 Str(1, 4, 9) = " `aktzeit` datetime DEFAULT NULL"
 Str(1, 4, 10) = "  PRIMARY KEY (`idarzt`)"
 Str(1, 4, 11) = "  UNIQUE KEY `lanr` (`LANR`)"
 Str(1, 4, 12) = "  KEY `fk_arzt_titel1` (`titel_id`)"
 Str(1, 4, 13) = "  KEY `fk_arzt_nlart1` (`nlart_id`)"
 Str(1, 4, 14) = "  KEY `namen` (`Nachname`,`Vorname`)"
 Str(1, 4, 15) = "  CONSTRAINT `fk_arzt_nlart1` FOREIGN KEY (`nlart_id`) REFERENCES `nlart` (`idnlart`) ON DELETE NO ACTION ON UPDATE NO ACTION"
 Str(1, 4, 16) = "  CONSTRAINT `fk_arzt_titel1` FOREIGN KEY (`titel_id`) REFERENCES `titel` (`idtitel`) ON DELETE NO ACTION ON UPDATE NO ACTION"
 Str(1, 4, 17) = " ENGINE=InnoDB AUTO_INCREMENT=25594 DEFAULT CHARSET=latin1 COLLATE=latin1_german2_ci"
End Sub ' FüllStr4
...
Sub FüllStr5()
 ...
 Str(0, 5, 5) = "`aktzeit`"
 Str(0, 5, 6) = "`bs_id`"
 Str(0, 5, 7) = "`fk_Betriebsstätte_has_hausarzt_Betriebsstätte1`"
 Str(0, 5, 8) = "`fk_Betriebsstätte_has_hausarzt_hausarzt1`"
 Str(0, 5, 9) = "`fk_Betriebsstätte_has_hausarzt_Betriebsstätte1`"
 Str(0, 5, 10) = "`fk_Betriebsstätte_has_hausarzt_hausarzt1`"
 ArtZ(0, 5) = 5
 ArtZ(1, 5) = 3
 ArtZ(2, 5) = 2
 ...
 Str(1, 5, 5) = " `aktzeit` datetime DEFAULT NULL"
 Str(1, 5, 6) = "  PRIMARY KEY (`bs_id`,`arzt_id`)"
 Str(1, 5, 7) = "  KEY `fk_Betriebsstätte_has_hausarzt_Betriebsstätte1` (`bs_id`)"
 Str(1, 5, 8) = "  KEY `fk_Betriebsstätte_has_hausarzt_hausarzt1` (`arzt_id`)"
 Str(1, 5, 9) = "  CONSTRAINT `fk_Betriebsstätte_has_hausarzt_Betriebsstätte1` FOREIGN KEY (`bs_id`) REFERENCES `bs` (`idbs`) ON DELETE CASCADE ON UPDATE CASCADE"
 Str(1, 5, 10) = "  CONSTRAINT `fk_Betriebsstätte_has_hausarzt_hausarzt1` FOREIGN KEY (`arzt_id`) REFERENCES `arzt` (`idarzt`) ON DELETE CASCADE ON UPDATE CASCADE"
 Str(1, 5, 11) = " ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_german2_ci"
End Sub ' FüllStr5
...
Sub FüllStr13()
 ...
 Str(0, 13, 11) = "`Name`"
 Str(0, 13, 12) = "`idbs`"
 Str(0, 13, 13) = "`fk_Betriebsstätte_Ort1`"
 Str(0, 13, 14) = "`fk_betriebsstätte_bsart1`"
 Str(0, 13, 15) = "`fk_bs_sprechzeiten1`"
 Str(0, 13, 16) = "`fk_betriebsstätte_bsart1`"
 Str(0, 13, 17) = "`fk_Betriebsstätte_Ort1`"
 Str(0, 13, 18) = "`fk_bs_sprechzeiten1`"
 ArtZ(0, 13) = 11
 ArtZ(1, 13) = 4
 ArtZ(2, 13) = 3
 ...
 Str(1, 13, 10) = " `aktzeit` datetime DEFAULT NULL"
 Str(1, 13, 11) = " `Name` varchar(149) COLLATE latin1_german2_ci NOT NULL"
 Str(1, 13, 12) = "  PRIMARY KEY (`idbs`)"
 Str(1, 13, 13) = "  KEY `fk_Betriebsstätte_Ort1` (`Ort_id`)"
 Str(1, 13, 14) = "  KEY `fk_betriebsstätte_bsart1` (`bsart_id`)"
 Str(1, 13, 15) = "  KEY `fk_bs_sprechzeiten1` (`sprechzeiten_id`)"
 Str(1, 13, 16) = "  CONSTRAINT `fk_betriebsstätte_bsart1` FOREIGN KEY (`bsart_id`) REFERENCES `bsart` (`idbsart`) ON DELETE NO ACTION ON UPDATE NO ACTION"
 Str(1, 13, 17) = "  CONSTRAINT `fk_Betriebsstätte_Ort1` FOREIGN KEY (`Ort_id`) REFERENCES `ort` (`idOrt`) ON DELETE NO ACTION ON UPDATE NO ACTION"
 Str(1, 13, 18) = "  CONSTRAINT `fk_bs_sprechzeiten1` FOREIGN KEY (`sprechzeiten_id`) REFERENCES `sprechzeiten` (`idsprechzeiten`) ON DELETE NO ACTION ON UPDATE NO ACTION"
 Str(1, 13, 19) = " ENGINE=InnoDB AUTO_INCREMENT=20358 DEFAULT CHARSET=latin1 COLLATE=latin1_german2_ci COMMENT='Betriebsstätte'"
End Sub ' FüllStr13
...
Sub FüllStr19()
 ...
 Str(1, 19, 5) = " ENGINE=InnoDB AUTO_INCREMENT=181 DEFAULT CHARSET=latin1 COLLATE=latin1_german2_ci"
End Sub ' FüllStr19
...
Sub FüllStr20()
 ...
 Str(1, 20, 10) = " ENGINE=InnoDB AUTO_INCREMENT=441121 DEFAULT CHARSET=latin1 COLLATE=latin1_german2_ci"
End Sub ' FüllStr20
...
Sub FüllStr21()
 ...
 Str(1, 21, 5) = " ENGINE=InnoDB AUTO_INCREMENT=67 DEFAULT CHARSET=latin1 COLLATE=latin1_german2_ci"
End Sub ' FüllStr21
...
Sub FüllStr22()
 ...
 Str(1, 22, 5) = " ENGINE=InnoDB AUTO_INCREMENT=272 DEFAULT CHARSET=latin1 COLLATE=latin1_german2_ci"
End Sub ' FüllStr22
...
Sub FüllStr26()
 ...
 Str(1, 26, 5) = " ENGINE=InnoDB AUTO_INCREMENT=14220 DEFAULT CHARSET=latin1 COLLATE=latin1_german2_ci"
End Sub ' FüllStr26
...
Sub FüllStr27()
 ...
 Str(1, 27, 8) = " ENGINE=InnoDB AUTO_INCREMENT=224318 DEFAULT CHARSET=latin1 COLLATE=latin1_german2_ci"
End Sub ' FüllStr27
...
Sub FüllStr29()
 ...
 Str(1, 29, 5) = " ENGINE=InnoDB AUTO_INCREMENT=1866 DEFAULT CHARSET=latin1 COLLATE=latin1_german2_ci"
End Sub ' FüllStr29
...
Sub FüllStr30()
 ...
 Str(1, 30, 2) = " `Sprechzeiten` varchar(3800) COLLATE latin1_german2_ci DEFAULT NULL"
 Str(1, 30, 3) = "  PRIMARY KEY (`idsprechzeiten`)"
 Str(1, 30, 4) = " ENGINE=InnoDB AUTO_INCREMENT=13247 DEFAULT CHARSET=latin1 COLLATE=latin1_german2_ci"
End Sub ' FüllStr30
...
Sub FüllStr31()
 ...
 Str(1, 31, 8) = " ENGINE=InnoDB AUTO_INCREMENT=524073 DEFAULT CHARSET=latin1 COLLATE=latin1_german2_ci"
End Sub ' FüllStr31
...
Sub FüllStr32()
 ...
 Str(1, 32, 5) = " ENGINE=InnoDB AUTO_INCREMENT=676 DEFAULT CHARSET=latin1 COLLATE=latin1_german2_ci"
End Sub ' FüllStr32
...
Sub FüllStr33()
 ...
 Str(1, 33, 5) = " ENGINE=InnoDB AUTO_INCREMENT=752 DEFAULT CHARSET=latin1 COLLATE=latin1_german2_ci ROW_FORMAT=DYNAMIC"
End Sub ' FüllStr33
...
Public Function doMach_haerzte(DBn$, Optional Server$, Optional obStumm%=True) ' Datenbankname
 ...
 obProt = (Err.Number = 0)
 On Error GoTo fehler
 If LenB(server) = 0 Then Server = GetSvr(DbCn)
...
Function GetSvr$(DBCn As ADODB.Connection)
Dim spos&, sp2&
