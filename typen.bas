...
Public type namen
 ...
 cgm AS byte 'cgm tinyint '1=Libre Handy, 2=Libre Gerät, 3=Dexcom Handy, 4=Dexcom Gerät, 5=Simplera
 insanw AS byte 'insanw tinyint '1=Novopen, 2=Combo, 3=Insight, 4=Kaleido, 5=Medt.780, 6=Omnipod 5, 7=Dash, 6=TSlim, 7=Yourloops, 8=Ypsopump
end type
...
Public FUNCTION namenSpeichern(SammelInsert%, BezfSp%, Optional rAf&, Optional sfkco%)
 ...
 Call csql0.AppVar(Array(" INSERT ", sqlIgnore, "INTO `namen` (Pat_ID,TM_Pat_ID,lfdnr," & _
...
Public FUNCTION faelleSpeichern(SammelInsert%, BezfSp%, Optional rAf&, Optional sfkco%)
 Dim i&, rAFi&, Pid$, m%, sfnr%, altmode$, ErrD$, ErrN& ',sql0$
Dim j%
 Dim csql0 As New CString, csql As New CString
 Dim rs As New ADODB.recordset
...
Public FUNCTION auSpeichern(SammelInsert%, BezfSp%, Optional rAf&, Optional sfkco%)
 Dim i&, rAFi&, Pid$, m%, sfnr%, altmode$, ErrD$, ErrN& ',sql0$
 Dim csql0 As New CString, csql As New CString
 Dim rs As New ADODB.recordset
 T1 = Timer
...
Public FUNCTION briefeSpeichern(SammelInsert%, BezfSp%, Optional rAf&, Optional sfkco%)
 Dim i&, rAFi&, Pid$, m%, sfnr%, altmode$, ErrD$, ErrN& ',sql0$
 Dim csql0 As New CString, csql As New CString
 Dim rs As New ADODB.recordset
 T1 = Timer
...
Public FUNCTION diagnosenSpeichern(SammelInsert%, BezfSp%, Optional rAf&, Optional sfkco%)
 Dim i&, rAFi&, Pid$, m%, sfnr%, altmode$, ErrD$, ErrN& ',sql0$
 Dim csql0 As New CString, csql As New CString
 Dim rs As New ADODB.recordset
 T1 = Timer
...
Public FUNCTION dokumenteSpeichern(SammelInsert%, BezfSp%, Optional rAf&, Optional sfkco%)
 Dim i&, rAFi&, Pid$, m%, sfnr%, altmode$, ErrD$, ErrN& ',sql0$
 Dim csql0 As New CString, csql As New CString
 Dim rs As New ADODB.recordset
 T1 = Timer
...
Public FUNCTION eintraegeSpeichern(SammelInsert%, BezfSp%, Optional rAf&, Optional sfkco%)
 Dim i&, rAFi&, Pid$, m%, sfnr%, altmode$, ErrD$, ErrN& ',sql0$
 Dim csql0 As New CString, csql As New CString
 Dim rs As New ADODB.recordset
 T1 = Timer
...
Public FUNCTION formulareSpeichern(SammelInsert%, BezfSp%, Optional rAf&, Optional sfkco%)
 Dim i&, rAFi&, Pid$, m%, sfnr%, altmode$, ErrD$, ErrN& ',sql0$
 Dim csql0 As New CString, csql As New CString
 Dim rs As New ADODB.recordset
 Dim neuFormID&, j&
...
Public FUNCTION forminhkopfSpeichern(SammelInsert%, BezfSp%, Optional rAf&, Optional sfkco%)
 Dim i&, rAFi&, Pid$, m%, sfnr%, altmode$, ErrD$, ErrN& ',sql0$
 Dim csql0 As New CString, csql As New CString
 Dim rs As New ADODB.recordset
 T1 = Timer
...
Public FUNCTION forminhfeldSpeichern(SammelInsert%, BezfSp%, Optional rAf&, Optional sfkco%)
 Dim i&, rAFi&, Pid$, m%, sfnr%, altmode$, ErrD$, ErrN& ',sql0$
 Dim csql0 As New CString, csql As New CString
 Dim rs As New ADODB.recordset
 T1 = Timer
...
Public FUNCTION kheinweisSpeichern(SammelInsert%, BezfSp%, Optional rAf&, Optional sfkco%)
 Dim i&, rAFi&, Pid$, m%, sfnr%, altmode$, ErrD$, ErrN& ',sql0$
 Dim csql0 As New CString, csql As New CString
 Dim rs As New ADODB.recordset
 T1 = Timer
...
Public FUNCTION lbanforderungenSpeichern(SammelInsert%, BezfSp%, Optional rAf&, Optional sfkco%)
 Dim i&, rAFi&, Pid$, m%, sfnr%, altmode$, ErrD$, ErrN& ',sql0$
 Dim csql0 As New CString, csql As New CString
 Dim rs As New ADODB.recordset
 T1 = Timer
...
Public FUNCTION laborneuSpeichern(SammelInsert%, BezfSp%, Optional rAf&, Optional sfkco%)
 Dim i&, rAFi&, Pid$, m%, sfnr%, altmode$, ErrD$, ErrN& ',sql0$
 Dim csql0 As New CString, csql As New CString
 Dim rs As New ADODB.recordset
 T1 = Timer
...
Public FUNCTION leistungenSpeichern(SammelInsert%, BezfSp%, Optional rAf&, Optional sfkco%)
 Dim i&, rAFi&, Pid$, m%, sfnr%, altmode$, ErrD$, ErrN& ',sql0$
 Dim csql0 As New CString, csql As New CString
 Dim rs As New ADODB.recordset
 T1 = Timer
...
Public FUNCTION medplanSpeichern(SammelInsert%, BezfSp%, Optional rAf&, Optional sfkco%)
 Dim i&, rAFi&, Pid$, m%, sfnr%, altmode$, ErrD$, ErrN& ',sql0$
 Dim csql0 As New CString, csql As New CString
 Dim rs As New ADODB.recordset
 T1 = Timer
...
Public FUNCTION rezepteintraegeSpeichern(SammelInsert%, BezfSp%, Optional rAf&, Optional sfkco%)
 Dim i&, rAFi&, Pid$, m%, sfnr%, altmode$, ErrD$, ErrN& ',sql0$
 Dim csql0 As New CString, csql As New CString
 Dim rs As New ADODB.recordset
 T1 = Timer
...
Public FUNCTION rrSpeichern(SammelInsert%, BezfSp%, Optional rAf&, Optional sfkco%)
 Dim i&, rAFi&, Pid$, m%, sfnr%, altmode$, ErrD$, ErrN& ',sql0$
 Dim csql0 As New CString, csql As New CString
 Dim rs As New ADODB.recordset
 T1 = Timer
...
Public FUNCTION kvnrueSpeichern(SammelInsert%, BezfSp%, Optional rAf&, Optional sfkco%)
 Dim i&, rAFi&, Pid$, m%, sfnr%, altmode$, ErrD$, ErrN& ',sql0$
 Dim csql0 As New CString, csql As New CString
 Dim rs As New ADODB.recordset
 T1 = Timer
...
Public FUNCTION unbek_kennSpeichern(SammelInsert%, BezfSp%, Optional rAf&, Optional sfkco%)
 Dim i&, rAFi&, Pid$, m%, sfnr%, altmode$, ErrD$, ErrN& ',sql0$
 Dim csql0 As New CString, csql As New CString
 Dim rs As New ADODB.recordset
 T1 = Timer
...
Public FUNCTION dmpreiheSpeichern(SammelInsert%, BezfSp%, Optional rAf&, Optional sfkco%)
 Dim i&, rAFi&, Pid$, m%, sfnr%, altmode$, ErrD$, ErrN& ',sql0$
 Dim csql0 As New CString, csql As New CString
 Dim rs As New ADODB.recordset
 T1 = Timer
...
Public FUNCTION desktopSpeichern(SammelInsert%, BezfSp%, Optional rAf&, Optional sfkco%)
 Dim i&, rAFi&, Pid$, m%, sfnr%, altmode$, ErrD$, ErrN& ',sql0$
 Dim csql0 As New CString, csql As New CString
 Dim rs As New ADODB.recordset
 T1 = Timer
...
Public FUNCTION usdmSpeichern(SammelInsert%, BezfSp%, Optional rAf&, Optional sfkco%)
 Dim i&, rAFi&, Pid$, m%, sfnr%, altmode$, ErrD$, ErrN& ',sql0$
 Dim csql0 As New CString, csql As New CString
 Dim rs As New ADODB.recordset
 T1 = Timer
...
Public FUNCTION fussSpeichern(SammelInsert%, BezfSp%, Optional rAf&, Optional sfkco%)
 Dim i&, rAFi&, Pid$, m%, sfnr%, altmode$, ErrD$, ErrN& ',sql0$
 Dim csql0 As New CString, csql As New CString
 Dim rs As New ADODB.recordset
 T1 = Timer
...
Public FUNCTION ulcusSpeichern(SammelInsert%, BezfSp%, Optional rAf&, Optional sfkco%)
 Dim i&, rAFi&, Pid$, m%, sfnr%, altmode$, ErrD$, ErrN& ',sql0$
 Dim csql0 As New CString, csql As New CString
 Dim rs As New ADODB.recordset
 T1 = Timer
...
Public FUNCTION vkgdSpeichern(SammelInsert%, BezfSp%, Optional rAf&, Optional sfkco%)
 Dim i&, rAFi&, Pid$, m%, sfnr%, altmode$, ErrD$, ErrN& ',sql0$
 Dim csql0 As New CString, csql As New CString
 Dim rs As New ADODB.recordset
 T1 = Timer
...
Public FUNCTION swsSpeichern(SammelInsert%, BezfSp%, Optional rAf&, Optional sfkco%)
 Dim i&, rAFi&, Pid$, m%, sfnr%, altmode$, ErrD$, ErrN& ',sql0$
 Dim csql0 As New CString, csql As New CString
 Dim rs As New ADODB.recordset
 T1 = Timer
...
Public FUNCTION voplSpeichern(SammelInsert%, BezfSp%, Optional rAf&, Optional sfkco%)
 Dim i&, rAFi&, Pid$, m%, sfnr%, altmode$, ErrD$, ErrN& ',sql0$
 Dim csql0 As New CString, csql As New CString
 Dim rs As New ADODB.recordset
 T1 = Timer
...
Public FUNCTION laborxsaetzeSpeichern(SammelInsert%, BezfSp%, Optional rAf&, Optional sfkco%)
 Dim i&, rAFi&, Pid$, m%, sfnr%, altmode$, ErrD$, ErrN& ',sql0$
 Dim csql0 As New CString, csql As New CString
 Dim rs As New ADODB.recordset
 T1 = Timer
...
Public FUNCTION laborxeingelSpeichern(SammelInsert%, BezfSp%, Optional rAf&, Optional sfkco%)
 Dim i&, rAFi&, Pid$, m%, sfnr%, altmode$, ErrD$, ErrN& ',sql0$
 Dim csql0 As New CString, csql As New CString
 Dim rs As New ADODB.recordset
 T1 = Timer
...
Public FUNCTION laborxusSpeichern(SammelInsert%, BezfSp%, j&, Optional rAf&, Optional sfkco%)
 Dim i&, rAFi&, Pid$, m%, sfnr%, altmode$, ErrD$, ErrN& ',sql0$
 Dim csql0 As New CString, csql As New CString
 Dim rs As New ADODB.recordset
 T1 = Timer
...
Public FUNCTION laborxbaktSpeichern(SammelInsert%, BezfSp%, Optional rAf&, Optional sfkco%)
 Dim i&, rAFi&, Pid$, m%, sfnr%, altmode$, ErrD$, ErrN& ',sql0$
 Dim csql0 As New CString, csql As New CString
 Dim rs As New ADODB.recordset
 T1 = Timer
...
Public FUNCTION laborxwertSpeichern(SammelInsert%, BezfSp%, Optional rAf&, Optional sfkco%)
 Dim i&, rAFi&, Pid$, m%, sfnr%, altmode$, ErrD$, ErrN& ',sql0$
 Dim csql0 As New CString, csql As New CString
 Dim rs As New ADODB.recordset
 T1 = Timer
...
Public FUNCTION laborxleistSpeichern(SammelInsert%, BezfSp%, Optional rAf&, Optional sfkco%)
 Dim i&, rAFi&, Pid$, m%, sfnr%, altmode$, ErrD$, ErrN& ',sql0$
 Dim csql0 As New CString, csql As New CString
 Dim rs As New ADODB.recordset
 T1 = Timer
...
Public FUNCTION liuezSpeichern(SammelInsert%, BezfSp%, Optional rAf&, Optional sfkco%)
 Dim i&, rAFi&, Pid$, m%, sfnr%, altmode$, ErrD$, ErrN& ',sql0$
 Dim csql0 As New CString, csql As New CString
 Dim rs As New ADODB.recordset
 T1 = Timer
