...
#Else
 AnwPfad = App.Path
#END IF
 SELECT CASE MsgBox("FNr: " + CStr(ErrNumber) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & IIf(ISNULL(Err.Source), vNS, CStr(Err.Source)) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in laborysaetzeSpeichern/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume sql: If ErrNumber = 998 Then Resume sql Else Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
#Else
 AnwPfad = App.Path
#END IF
 SELECT CASE MsgBox("FNr: " + CStr(ErrNumber) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & IIf(ISNULL(Err.Source), vNS, CStr(Err.Source)) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in laboryeingelSpeichern/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume sql: If ErrNumber = 998 Then Resume sql Else Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
#Else
 AnwPfad = App.Path
#END IF
 SELECT CASE MsgBox("FNr: " + CStr(ErrNumber) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & IIf(ISNULL(Err.Source), vNS, CStr(Err.Source)) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in laboryusSpeichern/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume sql: If ErrNumber = 998 Then Resume sql Else Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
#Else
 AnwPfad = App.Path
#END IF
 SELECT CASE MsgBox("FNr: " + CStr(ErrNumber) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & IIf(ISNULL(Err.Source), vNS, CStr(Err.Source)) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in laborybaktSpeichern/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume sql: If ErrNumber = 998 Then Resume sql Else Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
#Else
 AnwPfad = App.Path
#END IF
 SELECT CASE MsgBox("FNr: " + CStr(ErrNumber) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & IIf(ISNULL(Err.Source), vNS, CStr(Err.Source)) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in laborywertSpeichern/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume sql: If ErrNumber = 998 Then Resume sql Else Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
#Else
 AnwPfad = App.Path
#END IF
 SELECT CASE MsgBox("FNr: " + CStr(ErrNumber) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & IIf(ISNULL(Err.Source), vNS, CStr(Err.Source)) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in laboryleistSpeichern/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume sql: If ErrNumber = 998 Then Resume sql Else Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
