...
Public type laborysaetze
 SatzID AS long 'SatzID int 'zum Bezug für LaborUS
 DatID AS long 'DatID int 'Bezug zu LaborDat
 ...
 ArztID AS long 'ArztID int 'Bezug auf lyaerzte
 LabID AS long 'LabID int 'Bezug zu labyplab
 ...
 Erstellungsdatum AS date 'Erstellungsdatum date '9103 Erstellungsdatum (Turbomed)
...
Public type laboryus
 ID AS long 'ID int 'eindeutige Identifikation
 UsLfd AS long 'UsLfd int 'Bezug auf LaborWert
 DatID AS long 'DatID int 'Bezug zu LaborDat
 ...
 Eingang AS date 'Eingang date 'Eingangsdatum im Labor
 Berichtsdatum AS date 'Berichtsdatum datetime '8302 Berichtsdatum
 Pat_ID AS long 'Pat_ID int '
 Nachname AS string 'Nachname varchar '3101
 Vorname AS string 'Vorname varchar '3102
 GebDat AS date 'GebDat date '3103
 Titel AS string 'Titel varchar '3104
 NVorsatz AS string 'NVorsatz varchar '3105
 NVors2 AS string 'NVors2 varchar '3120
 ...
 Pat_id_0 AS string 'Pat_id_0 varchar 'SELECT pat_id FROM namen WHERE nachname= AND vorname= AND gebdat=1900-01-00 00:00:00 AND kaufdat<=1900-01-00 00:00:00 AND pat_id<>0 AND pat_id<100000 GROUP BY pat_id
 Pat_id_1 AS string 'Pat_id_1 varchar 'SELECT pat_id FROM namen WHERE nachname= AND vorname= AND kaufdat<=1900-01-00 00:00:00 AND pat_id<>0 AND pat_id<100000 GROUP BY pat_id
 Pat_id_2 AS string 'Pat_id_2 varchar 'SELECT pat_id FROM namen n WHERE gebdat=1900-01-00 00:00:00 AND kaufdat<=1900-01-00 00:00:00 AND pat_id<>0 AND pat_id<100000 GROUP BY pat_id
 Pat_id_3 AS string 'Pat_id_3 varchar 'SELECT pat_id FROM namen WHERE gebdat=1900-01-00 00:00:00 AND geschlecht=  AND kaufdat<=1900-01-00 00:00:00 AND pat_id<>0 AND pat_id<100000 GROUP BY pat_id
 Pat_id_4 AS string 'Pat_id_4 varchar 'SELECT pat_id FROM namen WHERE nachname= AND gebdat=1900-01-00 00:00:00 AND geschlecht=  AND kaufdat<=1900-01-00 00:00:00 AND pat_id<>0 AND pat_id<100000 GROUP BY pat_id
 Pat_id_5 AS string 'Pat_id_5 varchar 'SELECT pat_id FROM namen WHERE nachname= AND gebdat=1900-01-00 00:00:00 AND kaufdat<=1900-01-00 00:00:00 AND pat_id<>0 AND pat_id<100000 GROUP BY pat_id
 Pat_id_6 AS string 'Pat_id_6 varchar 'SELECT pat_id FROM `laboryus` u WHERE gebdat=1900-01-00 00:00:00 AND auftragsschlüssel =  AND eingang = 1900-01-00 00:00:00 AND pat_id<>0 AND pat_id<100000 GROUP BY pat_id
 Pat_id_7 AS string 'Pat_id_7 varchar 'SELECT NULL
 ZeitpunktLaborneu AS date 'ZeitpunktLaborneu datetime 'Zeitpunkt der Untersuchung, die in Laborneu zugeordnet wurde
 Pat_id_Laborneu AS string 'Pat_id_Laborneu varchar 'Pat_ID aus Laborneu
 ...
 z7 AS long 'z7 int 'Zahl der Antworten aus laborneu
 SQL7 AS string 'SQL7 text 'SQL-Abfrage zur direkten Pat_id-Ermittlung aus laborneu
 namsp AS long 'namsp int 'Farbe der Namensspalte
 wertsp AS long 'wertsp int 'Farbe der Wertspalte
 termsp AS long 'termsp int 'Farbe der Terminspalte
 Termine AS string 'Termine longtext 'Termine
 ...
 Spalte_16 AS date 'Spalte_16 date '
end type

Public type laborybakt
 ID AS long 'ID int 'eindeutige Identifikation
 UsID AS long 'UsID int 'Bezug auf LaborUS
 NBID AS long 'NBID int 'Bezug auf Laborynb
 Verf AS string 'Verf varchar '8410 Test-Ident (Turbomed)
 ...
 KommID AS long 'KommID int 'Kommentar, Bezug auf lyhinw
 ErklID AS long 'ErklID int 'Erklärung, Bezug auf lyhinw
 HinwID AS long 'HinwID int 'Auftragshinweis, Bezug auf lyhinw
 QSpezID AS long 'QSpezID int '8431 Spezifikation, Bezug auf lyqspez
 Keimzahl AS string 'Keimzahl varchar '
 abrd AS string 'abrd varchar '8614 Abrechnung durch: 1 Labor, 2 Einweiser
 Hinweise AS string 'Hinweise varchar 'Hinweise
 fICD AS string 'fICD varchar 'fehlende ICDs
 hinwsp AS long 'hinwsp int 'Farbe der Hinweisspalte
 termsp AS long 'termsp int 'Farbe der Terminspalte
 fICDsp AS long 'fICDsp int 'Farbe der ICD-Spalte
 Vorwert_1 AS string 'Vorwert_1 varchar 'Vorwert 1
 Vorwert_2 AS string 'Vorwert_2 varchar 'Vorwert 2
 QSpez AS string 'QSpez varchar '8431 Probenmaterial-Spezifikation (Turbomed)
end type

Public type laborywert
 ID AS long 'ID int 'eindeutige Identifikation
 UsID AS long 'UsID int 'Bezug auf LaborUS
 BaktID AS long 'BaktID int 'Bezug auf lybakt
 NBID AS long 'NBID int 'Bezug auf Laborynb
 Abkü AS string 'Abkü varchar '8410 maximale Länge: 8
 Langtext AS string 'Langtext varchar '8411 Testbezeichnung Turbomed
 KuQu AS string 'KuQu varchar '8428 Probenmaterial-Ident (Turbomed)
 Quelle AS string 'Quelle varchar '8430 Probenmaterial-Bezeichnung (Turbomed)
 AbnDat AS date 'AbnDat datetime '8432 Abnahmedatum (Turbomed)
 Wert AS string 'Wert varchar '8420 Ergebniswert (Turbomed)
 Einheit AS string 'Einheit varchar '8421 (maximale Länge: 12)
...
Public rSw() AS sws
Public rVo() AS vopl
Public rLs() AS laborysaetze
Public rLg() AS laboryeingel
Public rLu() AS laboryus
Public rLo() AS laborybakt
Public rLw() AS laborywert
Public rLL() AS laboryleist
Public rLi() AS liuez
...
Public roSw() AS sws
Public roVo() AS vopl
Public roLs() AS laborysaetze
Public roLg() AS laboryeingel
Public roLu() AS laboryus
Public roLo() AS laborybakt
Public roLw() AS laborywert
Public roLL() AS laboryleist
...
Public Sub LöschePat(PID&, Optional obAnzeig%, Optional ohneLabor%)
 ...
 syscmd 4, "Fertig mit Löschen von Pat. " & pid
 Exit Sub
fehler:
 Dim AnwPfad$
 #If VBA6 THEN
 ...
 #Else
  AnwPfad = App.Path
 #END IF
 SELECT CASE MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in LöschePat/" + AnwPfad)
...
fehler:
 ...
 AnwPfad = App.Path
 #END IF
 SELECT CASE MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in allesLösch/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
Public FUNCTION LabLösch(frm AS lese)
 ...
 call doEntleer(frm, "laboryleist")
 call doEntleer(frm, "laborywert")
 call doEntleer(frm, "laborybakt")
 call doEntleer(frm, "laboryus")
 call doEntleer(frm, "laboryeingel")
 call doEntleer(frm, "laborysaetze")
 call doentleer(frm, vorsil & "plab")
 call doentleer(frm, vorsil & "pneu")
 call doentleer(frm, vorsil & "pnb")
 call ForeignYes0
 call ForeignYes1
 Exit Function
fehler:
 ...
 AnwPfad = App.Path
 #END IF
 SELECT CASE MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in LabLösch/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.Path
 #END IF
 SELECT CASE MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in namenLaden/" + AnwPfad)
...
fehler:
 ...
 AnwPfad = App.path
 #END IF
 Select Case MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in namenEinf/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox(" Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END Select
...
sql:
 ...
 For i = 0 to ubound(rNa)
  ...
  If i Mod 10 = 0 Then syscmd 4, pid & ": Speichere Satz " & i & "/" & UBound(rNa) + 0 & " in `" & Tbnm & "`"
setz:
  ...
  csql.AppVar Array("(" , rNa(i).Pat_ID, "," , rNa(i).TM_Pat_ID, "," , rNa(i).lfdnr, ",'" , rNa(i).NVorsatz, "','" , rNa(i).Nachname, "','" , rNa(i).Vorname, "'," , DatFor_k(rNa(i).GebDat), ",'" , rNa(i).KarGen, "','" ,  _
   ...
   rNa(i).LK_2, "','" , rNa(i).Postfach, "','" , rNa(i).Beruf, "','" , rNa(i).Weggeldzone, "'," , replace$(rNa(i).WeggzZahl,",","."), "," , DatFor_k(rNa(i).AufnDat), "," , DatFor_k(rNa(i).kAufDat), ",'" ,  _
   rNa(i).LANR, "','" , rNa(i).BStNr, "','" , rNa(i).Titel, "','" , rNa(i).Versichertennummer, "','" , rNa(i).PrivatTel, "','" , rNa(i).KVNr, "','" , rNa(i).KVNr2, "','" , rNa(i).KVNr3, "','" ,  _
   rNa(i).KVNr4, "','" , rNa(i).PrivatTel_2, "','" , rNa(i).PrivatFax, "','" , rNa(i).DienstTel, "','" , rNa(i).PrivatMobil, "','" , rNa(i).Email, "','" , rNa(i).Arbeitgeber, "'," , cstr(-(rNa(i).AnAllgda<>0)) , "," , cstr(-( _
   rNa(i).An1da<>0)) , "," , cstr(-(rNa(i).An2da<>0)) , "," , cstr(-(rNa(i).Checkda<>0)) , ",'" , rNa(i).DMTypaD, "'," , DatFor_k( 0 ), "," , rNa(i).absPos, "," ,  _
   rNa(i).StByte, "," , rNa(i).StByteA, ",'" , rNa(i).Cave, "','" , rNa(i).notiz, "','" , rNa(i).info, "','" , rNa(i).obChk, "'," , rNa(i).NZNr, "," , rNa(i).dmpklass, "," , DatFor_k(rNa(i).dmpbeg), "," ,  _
   rNa(i).dmpkhkklass, "," , DatFor_k(rNa(i).dmpkhkbeg), "," , rNa(i).dmpcopdklass, "," , DatFor_k(rNa(i).dmpcopdbeg), "," , rNa(i).dmpabklass, "," , DatFor_k(rNa(i).dmpabbeg), "," ,  _
   rNa(i).dmposteoklass, "," , DatFor_k(rNa(i).dmposteobeg), "," , rNa(i).dmpraklass, "," , DatFor_k(rNa(i).dmprabeg), "," , rNa(i).dmpchiklass, "," , DatFor_k(rNa(i).dmpchibeg), "," , rNa(i).dmprsklass, "," , DatFor_k( _
   rNa(i).dmprsbeg), "," , rNa(i).dmpadklass, "," , DatFor_k(rNa(i).dmpadbeg), "," , rNa(i).dmpdepklass, "," , DatFor_k(rNa(i).dmpdepbeg), "," , DatFor_k(rNa(i).dakab), "," ,  _
   rNa(i).HzV, "," , DatFor_k(rNa(i).HzVbeg), "," , rNa(i).DS, "," , DatFor_k(rNa(i).DSbeg), "," , rNa(i).getHA0, ",'" , rNa(i).fnHA0, "'," , rNa(i).getHA1, ",'" , rNa(i).fnHA1, "'," , rNa(i).getHA2, ",'" ,  _
   rNa(i).fnHA2, "','" , rNa(i).zubenach, "','" , rNa(i).Verwandt, "','" , rNa(i).Sprache, "'," , DatFor_k(rNa(i).SDatum), "," , rNa(i).inaktiv, "," , DatFor_k(rNa(i).lAktTM), "," ,  _
   rNa(i).Mitarbeiter, "," , rNa(i).Swz, "," , rNa(i).Gbz, "," , rNa(i).Kiz, "," , rNa(i).ZdeK, "," , cstr(-(rNa(i).obk<>0)) , "," , cstr(-(rNa(i).obs<>0)) , "," , cstr(-(rNa(i).obh<>0)) , "," , cstr(-( _
   rNa(i).antikoag<>0)) , "," , cstr(-(rNa(i).dmt1<>0)) , "," , cstr(-(rNa(i).gdm<>0)) , "," , cstr(-(rNa(i).kdm<>0)) , "," , rNa(i).cgm, "," , DatFor_k(rNa(i).insdat), "," , rNa(i).insanw, ")")
...
#Else
 AnwPfad = App.Path
#END IF
 SELECT CASE MsgBox("FNr: " + CStr(ErrNumber) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in namenSpeichern/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
...
fehler:
 ...
 AnwPfad = App.Path
 #END IF
 SELECT CASE MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in faelleLaden/" + AnwPfad)
  Case vbAbort: Call MsgBox(" 2Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.path
 #END IF
 Select Case MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in faelleEinf/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox(" Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END Select
...
sql:
 ...
 For i = 1 to ubound(rFa)
  ...
  If i Mod 10 = 0 Then syscmd 4, pid & ": Speichere Satz " & i & "/" & UBound(rFa) + 0 & " in `" & Tbnm & "`"
setz:
  ...
  csql.AppVar Array("(" , rFa(i).Pat_ID, ",'" , rFa(i).Quartal, "','" , rFa(i).Nachname, "','" , rFa(i).Vorname, "'," , DatFor_k(rFa(i).DtlOnlPfg), "," , rFa(i).ErgbdOnlP, "," , rFa(i).ErrorCode, ",'" , rFa(i).PrüfZdFd, "'," ,  _
   ...
   rFa(i).Befund, "','" , rFa(i).statKlasse, "','" , rFa(i).KHNam, "'," , rFa(i).statBehTage, "," , replace$(rFa(i).SchGr,",","."), ",'" , rFa(i).Weiterbeh, "'," , replace$(rFa(i).KurAbb,",","."), ",'" ,  _
   rFa(i).VermiArt, "'," , rFa(i).VermiCode, "," , DatFor_k(rFa(i).VermiDatum), ",'" , rFa(i).VermiZusatz, "','" , rFa(i).PGeb, "','" , rFa(i).PGebErg, "','" , rFa(i).Mahnfrist, "','" ,  _
   rFa(i).Unfallort, "','" , rFa(i).BeschAls, "'," , DatFor_k(rFa(i).BeschSeit), ",'" , rFa(i).Unfallbetrieb, "','" , rFa(i).bHeilb, "','" , rFa(i).GOÄKatNr, "','" , rFa(i).GOÄKatName, "','" ,  _
   rFa(i).abrArzt, "','" , rFa(i).privVers, "','" , rFa(i).AdNam, "','" , rFa(i).AdStr, "','" , rFa(i).AdPlz, "','" , rFa(i).AdOrt, "','" , rFa(i).ÜwBG, "'," , DatFor_k(rFa(i).BhFE), ",'" , rFa(i).s8000, "','" ,  _
   rFa(i).s8100, "'," , DatFor_k(rFa(i).AktZeit), "," , DatFor_k(rFa(i).Fanf), ",'" , rFa(i).altQuart, "'," , DatFor_k(rFa(i).QAnf), "," , DatFor_k(rFa(i).QEnd), ",'" , rFa(i).QS, "','" ,  _
   rFa(i).QT, "'," , rFa(i).StByte, "," , rFa(i).absPos, "," , rFa(i).LANRid, ",'" , rFa(i).ZnrMLes, "','" , rFa(i).BGFallNr, "'," , replace$(rFa(i).lGewicht,",","."), "," , DatFor_k(rFa(i).vorET), ",'" ,  _
   rFa(i).dmpVertret, "','" , rFa(i).dmpArztw, "','" , rFa(i).dmpHypos, "','" , rFa(i).dmpKhsA, "','" , rFa(i).dmpDMSchulEmpf, "','" , rFa(i).dmpDMSchulWahrg, "','" , rFa(i).dmpHypertSchulEmpf, "','")
  csql.AppVar Array(rFa(i).dmpHypertSchulWahrg, "','" , rFa(i).dmpKKTabakEmpf, "','" , rFa(i).dmpKKErnEmpf, "','" , rFa(i).dmpKKkTrainEmpf, "','" , rFa(i).dmpHbA1cZiel, "','" ,  _
   rFa(i).dmpUewFuss, "','" , rFa(i).dmpEinwDM, "','" , rFa(i).dmphalbj, "','" , rFa(i).dmpMA, "')")
...
IF ErrNumber = -2147467259 THEN
 ...
 If rFa(i).SchGr = 90 Or rFa(i).SchGr = 89 Then kat = "PRI" Else kat = holKat(uKas)
...
#Else
 AnwPfad = App.Path
#END IF
 SELECT CASE MsgBox("FNr: " + CStr(ErrNumber) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in faelleSpeichern/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume sql: If ErrNumber = 998 Then Resume sql Else Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.Path
 #END IF
 SELECT CASE MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in auLaden/" + AnwPfad)
  Case vbAbort: Call MsgBox(" 2Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.path
 #END IF
 Select Case MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in auEinf/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox(" Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END Select
...
sql:
 ...
 For i = 1 to ubound(rAu)
  ...
  If i Mod 10 = 0 Then syscmd 4, pid & ": Speichere Satz " & i & "/" & UBound(rAu) + 0 & " in `" & Tbnm & "`"
setz:
  IF SammelInsert = 0 Or i = 1 Then
   csql.Append csql0
  End If ' SammelInsert = 0 Or i = 1 Then
...
#Else
 AnwPfad = App.Path
#END IF
 SELECT CASE MsgBox("FNr: " + CStr(ErrNumber) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in auSpeichern/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume sql: If ErrNumber = 998 Then Resume sql Else Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.Path
 #END IF
 SELECT CASE MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in briefeLaden/" + AnwPfad)
  Case vbAbort: Call MsgBox(" 2Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.path
 #END IF
 Select Case MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in briefeEinf/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox(" Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END Select
...
sql:
 ...
 For i = 1 to ubound(rBr)
  ...
  If i Mod 10 = 0 Then syscmd 4, pid & ": Speichere Satz " & i & "/" & UBound(rBr) + 0 & " in `" & Tbnm & "`"
setz:
  IF SammelInsert = 0 Or i = 1 Then
   csql.Append csql0
  End If ' SammelInsert = 0 Or i = 1 Then
...
#Else
 AnwPfad = App.Path
#END IF
 SELECT CASE MsgBox("FNr: " + CStr(ErrNumber) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in briefeSpeichern/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume sql: If ErrNumber = 998 Then Resume sql Else Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.Path
 #END IF
 SELECT CASE MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in diagnosenLaden/" + AnwPfad)
  Case vbAbort: Call MsgBox(" 2Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.path
 #END IF
 Select Case MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in diagnosenEinf/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox(" Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END Select
...
sql:
 ...
 For i = 1 to ubound(rDi)
  ...
  If i Mod 10 = 0 Then syscmd 4, pid & ": Speichere Satz " & i & "/" & UBound(rDi) + 0 & " in `" & Tbnm & "`"
setz:
  IF SammelInsert = 0 Or i = 1 Then
   csql.Append csql0
  End If ' SammelInsert = 0 Or i = 1 Then
...
#Else
 AnwPfad = App.Path
#END IF
 SELECT CASE MsgBox("FNr: " + CStr(ErrNumber) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in diagnosenSpeichern/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume sql: If ErrNumber = 998 Then Resume sql Else Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.Path
 #END IF
 SELECT CASE MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in dokumenteLaden/" + AnwPfad)
  Case vbAbort: Call MsgBox(" 2Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.path
 #END IF
 Select Case MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in dokumenteEinf/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox(" Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END Select
...
sql:
 ...
 For i = 1 to ubound(rDo)
  ...
  If i Mod 10 = 0 Then syscmd 4, pid & ": Speichere Satz " & i & "/" & UBound(rDo) + 0 & " in `" & Tbnm & "`"
setz:
  IF SammelInsert = 0 Or i = 1 Then
   csql.Append csql0
  End If ' SammelInsert = 0 Or i = 1 Then
...
#Else
 AnwPfad = App.Path
#END IF
 SELECT CASE MsgBox("FNr: " + CStr(ErrNumber) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in dokumenteSpeichern/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume sql: If ErrNumber = 998 Then Resume sql Else Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.Path
 #END IF
 SELECT CASE MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in eintraegeLaden/" + AnwPfad)
  Case vbAbort: Call MsgBox(" 2Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.path
 #END IF
 Select Case MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in eintraegeEinf/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox(" Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END Select
...
sql:
 ...
 For i = 1 to ubound(rEi)
  ...
  If i Mod 10 = 0 Then syscmd 4, pid & ": Speichere Satz " & i & "/" & UBound(rEi) + 0 & " in `" & Tbnm & "`"
setz:
  IF SammelInsert = 0 Or i = 1 Then
   csql.Append csql0
  End If ' SammelInsert = 0 Or i = 1 Then
...
#Else
 AnwPfad = App.Path
#END IF
 SELECT CASE MsgBox("FNr: " + CStr(ErrNumber) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in eintraegeSpeichern/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume sql: If ErrNumber = 998 Then Resume sql Else Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
sql:
 ...
 If rFo(i).FormID < 0 Then
  ...
  If i Mod 10 = 0 Then syscmd 4, pid & ": Speichere Satz " & i & "/" & UBound(rFo) + 0 & " in `" & Tbnm & "`"
setz:
   csql.Append csql0
...
#Else
 AnwPfad = App.Path
#END IF
 SELECT CASE MsgBox("FNr: " + CStr(ErrNumber) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in formulareSpeichern/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume sql: If ErrNumber = 998 Then Resume sql Else Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.Path
 #END IF
 SELECT CASE MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in forminhkopfLaden/" + AnwPfad)
  Case vbAbort: Call MsgBox(" 2Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.path
 #END IF
 Select Case MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in forminhkopfEinf/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox(" Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END Select
...
sql:
 ...
 For i = 1 to ubound(rFr)
  ...
  If i Mod 10 = 0 Then syscmd 4, pid & ": Speichere Satz " & i & "/" & UBound(rFr) + 0 & " in `" & Tbnm & "`"
setz:
  IF SammelInsert = 0 Or i = 1 Then
   csql.Append csql0
  End If ' SammelInsert = 0 Or i = 1 Then
...
#Else
 AnwPfad = App.Path
#END IF
 SELECT CASE MsgBox("FNr: " + CStr(ErrNumber) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in forminhkopfSpeichern/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume sql: If ErrNumber = 998 Then Resume sql Else Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
sql:
 csql.m_Len = 0
 For i = 1 to ubound(rFm)
  If i Mod 10 = 0 Then syscmd 4, pid & ": Speichere Satz " & i & "/" & UBound(rFm) + 0 & " in `" & Tbnm & "`"
setz:
  IF SammelInsert = 0 Or i = 1 Then
   csql.Append csql0
  End If ' SammelInsert = 0 Or i = 1 Then
...
#Else
 AnwPfad = App.Path
#END IF
 SELECT CASE MsgBox("FNr: " + CStr(ErrNumber) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in forminhfeldSpeichern/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume sql: If ErrNumber = 998 Then Resume sql Else Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.Path
 #END IF
 SELECT CASE MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in kheinweisLaden/" + AnwPfad)
  Case vbAbort: Call MsgBox(" 2Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.path
 #END IF
 Select Case MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in kheinweisEinf/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox(" Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END Select
...
sql:
 ...
 For i = 1 to ubound(rKh)
  ...
  If i Mod 10 = 0 Then syscmd 4, pid & ": Speichere Satz " & i & "/" & UBound(rKh) + 0 & " in `" & Tbnm & "`"
setz:
  IF SammelInsert = 0 Or i = 1 Then
   csql.Append csql0
  End If ' SammelInsert = 0 Or i = 1 Then
...
#Else
 AnwPfad = App.Path
#END IF
 SELECT CASE MsgBox("FNr: " + CStr(ErrNumber) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in kheinweisSpeichern/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume sql: If ErrNumber = 998 Then Resume sql Else Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.Path
 #END IF
 SELECT CASE MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in lbanforderungenLaden/" + AnwPfad)
  Case vbAbort: Call MsgBox(" 2Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.path
 #END IF
 Select Case MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in lbanforderungenEinf/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox(" Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END Select
...
sql:
 ...
 For i = 1 to ubound(rLb)
  ...
  If i Mod 10 = 0 Then syscmd 4, pid & ": Speichere Satz " & i & "/" & UBound(rLb) + 0 & " in `" & Tbnm & "`"
setz:
  IF SammelInsert = 0 Or i = 1 Then
   csql.Append csql0
  End If ' SammelInsert = 0 Or i = 1 Then
...
#Else
 AnwPfad = App.Path
#END IF
 SELECT CASE MsgBox("FNr: " + CStr(ErrNumber) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in lbanforderungenSpeichern/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume sql: If ErrNumber = 998 Then Resume sql Else Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.Path
 #END IF
 SELECT CASE MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in laborneuLaden/" + AnwPfad)
  Case vbAbort: Call MsgBox(" 2Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.path
 #END IF
 Select Case MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in laborneuEinf/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox(" Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END Select
...
sql:
 ...
 For i = 1 to ubound(rLa)
  ...
  If i Mod 10 = 0 Then syscmd 4, pid & ": Speichere Satz " & i & "/" & UBound(rLa) + 0 & " in `" & Tbnm & "`"
setz:
  IF SammelInsert = 0 Or i = 1 Then
   csql.Append csql0
  End If ' SammelInsert = 0 Or i = 1 Then
...
#Else
 AnwPfad = App.Path
#END IF
 SELECT CASE MsgBox("FNr: " + CStr(ErrNumber) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in laborneuSpeichern/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume sql: If ErrNumber = 998 Then Resume sql Else Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.Path
 #END IF
 SELECT CASE MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in leistungenLaden/" + AnwPfad)
  Case vbAbort: Call MsgBox(" 2Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.path
 #END IF
 Select Case MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in leistungenEinf/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox(" Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END Select
...
sql:
 ...
 For i = 1 to ubound(rLe)
  ...
  If i Mod 10 = 0 Then syscmd 4, pid & ": Speichere Satz " & i & "/" & UBound(rLe) + 0 & " in `" & Tbnm & "`"
setz:
  IF SammelInsert = 0 Or i = 1 Then
   csql.Append csql0
  End If ' SammelInsert = 0 Or i = 1 Then
  csql.AppVar Array("(" , rLe(i).FID, "," , rLe(i).Pat_ID, "," , DatFor_k(rLe(i).ZeitPunkt), ",'" , rLe(i).Leistung, "','" , rLe(i).ArtdUs, "','" , rLe(i).LAnzl, "','" , rLe(i).LUhrz, "','" , rLe(i).LfBegr, "','" ,  _
   ...
   rLe(i).Pruefzeit, "," , rLe(i).Kalkzeit, "," , rLe(i).Bsnr, "," , rLe(i).Abrechnungssperre, "," , rLe(i).Medikanr, "," , rLe(i).Laborkosten, "," , rLe(i).Sachkostentyp, ",'" ,  _
   rLe(i).Usegebordtext, "','" , rLe(i).Arztliste, "','" , rLe(i).Ersteller, "','" , rLe(i).Änderer, "','" , rLe(i).Kennzeichen_arzt_technik, "','" , rLe(i).Auftragsschluessel, "','" , rLe(i).Auftragstext, "')")
...
#Else
 AnwPfad = App.Path
#END IF
 SELECT CASE MsgBox("FNr: " + CStr(ErrNumber) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in leistungenSpeichern/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume sql: If ErrNumber = 998 Then Resume sql Else Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.Path
 #END IF
 SELECT CASE MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in medplanLaden/" + AnwPfad)
  Case vbAbort: Call MsgBox(" 2Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.path
 #END IF
 Select Case MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in medplanEinf/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox(" Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END Select
...
sql:
 ...
 For i = 1 to ubound(rMe)
  ...
  If i Mod 10 = 0 Then syscmd 4, pid & ": Speichere Satz " & i & "/" & UBound(rMe) + 0 & " in `" & Tbnm & "`"
setz:
  IF SammelInsert = 0 Or i = 1 Then
   csql.Append csql0
  End If ' SammelInsert = 0 Or i = 1 Then
...
#Else
 AnwPfad = App.Path
#END IF
 SELECT CASE MsgBox("FNr: " + CStr(ErrNumber) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in medplanSpeichern/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume sql: If ErrNumber = 998 Then Resume sql Else Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.Path
 #END IF
 SELECT CASE MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in rezepteintraegeLaden/" + AnwPfad)
  Case vbAbort: Call MsgBox(" 2Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.path
 #END IF
 Select Case MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in rezepteintraegeEinf/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox(" Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END Select
...
sql:
 ...
 For i = 1 to ubound(rRe)
  ...
  If i Mod 10 = 0 Then syscmd 4, pid & ": Speichere Satz " & i & "/" & UBound(rRe) + 0 & " in `" & Tbnm & "`"
setz:
  IF SammelInsert = 0 Or i = 1 Then
   csql.Append csql0
  End If ' SammelInsert = 0 Or i = 1 Then
...
#Else
 AnwPfad = App.Path
#END IF
 SELECT CASE MsgBox("FNr: " + CStr(ErrNumber) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in rezepteintraegeSpeichern/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume sql: If ErrNumber = 998 Then Resume sql Else Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.Path
 #END IF
 SELECT CASE MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in rrLaden/" + AnwPfad)
  Case vbAbort: Call MsgBox(" 2Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.path
 #END IF
 Select Case MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in rrEinf/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox(" Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END Select
...
sql:
 ...
 For i = 1 to ubound(rRr)
  ...
  If i Mod 10 = 0 Then syscmd 4, pid & ": Speichere Satz " & i & "/" & UBound(rRr) + 0 & " in `" & Tbnm & "`"
setz:
  IF SammelInsert = 0 Or i = 1 Then
   csql.Append csql0
  End If ' SammelInsert = 0 Or i = 1 Then
...
#Else
 AnwPfad = App.Path
#END IF
 SELECT CASE MsgBox("FNr: " + CStr(ErrNumber) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in rrSpeichern/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume sql: If ErrNumber = 998 Then Resume sql Else Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
sql:
 ...
 For i = 1 to ubound(rKv)
  ...
  If i Mod 10 = 0 Then syscmd 4, pid & ": Speichere Satz " & i & "/" & UBound(rKv) + 0 & " in `" & Tbnm & "`"
setz:
  IF SammelInsert = 0 Or i = 1 Then
   csql.Append csql0
  End If ' SammelInsert = 0 Or i = 1 Then
...
#Else
 AnwPfad = App.Path
#END IF
 SELECT CASE MsgBox("FNr: " + CStr(ErrNumber) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in kvnrueSpeichern/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume sql: If ErrNumber = 998 Then Resume sql Else Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
sql:
 ...
 For i = rUn1 + 1 to ubound(rUn)
  ...
  If i Mod 10 = 0 Then syscmd 4, pid & ": Speichere Satz " & i & "/" & UBound(rUn) + 0 & " in `" & Tbnm & "`"
setz:
...
#Else
 AnwPfad = App.Path
#END IF
 SELECT CASE MsgBox("FNr: " + CStr(ErrNumber) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in unbek_kennSpeichern/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume sql: If ErrNumber = 998 Then Resume sql Else Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.Path
 #END IF
 SELECT CASE MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in dmpreiheLaden/" + AnwPfad)
  Case vbAbort: Call MsgBox(" 2Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.path
 #END IF
 Select Case MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in dmpreiheEinf/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox(" Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END Select
...
sql:
 ...
 For i = 1 to ubound(rDm)
  ...
  If i Mod 10 = 0 Then syscmd 4, pid & ": Speichere Satz " & i & "/" & UBound(rDm) + 0 & " in `" & Tbnm & "`"
setz:
  IF SammelInsert = 0 Or i = 1 Then
   csql.Append csql0
  End If ' SammelInsert = 0 Or i = 1 Then
...
#Else
 AnwPfad = App.Path
#END IF
 SELECT CASE MsgBox("FNr: " + CStr(ErrNumber) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in dmpreiheSpeichern/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume sql: If ErrNumber = 998 Then Resume sql Else Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.Path
 #END IF
 SELECT CASE MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in desktopLaden/" + AnwPfad)
  Case vbAbort: Call MsgBox(" 2Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.path
 #END IF
 Select Case MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in desktopEinf/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox(" Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END Select
...
sql:
 ...
 For i = 1 to ubound(rDe)
  ...
  If i Mod 10 = 0 Then syscmd 4, pid & ": Speichere Satz " & i & "/" & UBound(rDe) + 0 & " in `" & Tbnm & "`"
setz:
  IF SammelInsert = 0 Or i = 1 Then
   csql.Append csql0
  End If ' SammelInsert = 0 Or i = 1 Then
...
#Else
 AnwPfad = App.Path
#END IF
 SELECT CASE MsgBox("FNr: " + CStr(ErrNumber) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in desktopSpeichern/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume sql: If ErrNumber = 998 Then Resume sql Else Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.Path
 #END IF
 SELECT CASE MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in usdmLaden/" + AnwPfad)
  Case vbAbort: Call MsgBox(" 2Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.path
 #END IF
 Select Case MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in usdmEinf/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox(" Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END Select
...
sql:
 ...
 For i = 1 to ubound(rUs)
  ...
  If i Mod 10 = 0 Then syscmd 4, pid & ": Speichere Satz " & i & "/" & UBound(rUs) + 0 & " in `" & Tbnm & "`"
setz:
  IF SammelInsert = 0 Or i = 1 Then
   csql.Append csql0
  End If ' SammelInsert = 0 Or i = 1 Then
...
#Else
 AnwPfad = App.Path
#END IF
 SELECT CASE MsgBox("FNr: " + CStr(ErrNumber) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in usdmSpeichern/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume sql: If ErrNumber = 998 Then Resume sql Else Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.Path
 #END IF
 SELECT CASE MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in fussLaden/" + AnwPfad)
  Case vbAbort: Call MsgBox(" 2Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.path
 #END IF
 Select Case MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in fussEinf/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox(" Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END Select
...
sql:
 ...
 For i = 1 to ubound(rFu)
  ...
  If i Mod 10 = 0 Then syscmd 4, pid & ": Speichere Satz " & i & "/" & UBound(rFu) + 0 & " in `" & Tbnm & "`"
setz:
  IF SammelInsert = 0 Or i = 1 Then
   csql.Append csql0
  End If ' SammelInsert = 0 Or i = 1 Then
...
#Else
 AnwPfad = App.Path
#END IF
 SELECT CASE MsgBox("FNr: " + CStr(ErrNumber) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in fussSpeichern/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume sql: If ErrNumber = 998 Then Resume sql Else Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.Path
 #END IF
 SELECT CASE MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in ulcusLaden/" + AnwPfad)
  Case vbAbort: Call MsgBox(" 2Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.path
 #END IF
 Select Case MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in ulcusEinf/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox(" Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END Select
...
sql:
 ...
 For i = 1 to ubound(rUl)
  ...
  If i Mod 10 = 0 Then syscmd 4, pid & ": Speichere Satz " & i & "/" & UBound(rUl) + 0 & " in `" & Tbnm & "`"
setz:
  IF SammelInsert = 0 Or i = 1 Then
   csql.Append csql0
  End If ' SammelInsert = 0 Or i = 1 Then
...
#Else
 AnwPfad = App.Path
#END IF
 SELECT CASE MsgBox("FNr: " + CStr(ErrNumber) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in ulcusSpeichern/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume sql: If ErrNumber = 998 Then Resume sql Else Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.Path
 #END IF
 SELECT CASE MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in vkgdLaden/" + AnwPfad)
  Case vbAbort: Call MsgBox(" 2Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.path
 #END IF
 Select Case MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in vkgdEinf/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox(" Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END Select
...
sql:
 ...
 For i = 1 to ubound(rVk)
  ...
  If i Mod 10 = 0 Then syscmd 4, pid & ": Speichere Satz " & i & "/" & UBound(rVk) + 0 & " in `" & Tbnm & "`"
setz:
  IF SammelInsert = 0 Or i = 1 Then
   csql.Append csql0
  End If ' SammelInsert = 0 Or i = 1 Then
...
#Else
 AnwPfad = App.Path
#END IF
 SELECT CASE MsgBox("FNr: " + CStr(ErrNumber) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in vkgdSpeichern/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume sql: If ErrNumber = 998 Then Resume sql Else Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.Path
 #END IF
 SELECT CASE MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in swsLaden/" + AnwPfad)
  Case vbAbort: Call MsgBox(" 2Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.path
 #END IF
 Select Case MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in swsEinf/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox(" Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END Select
...
sql:
 ...
 For i = 1 to ubound(rSw)
  ...
  If i Mod 10 = 0 Then syscmd 4, pid & ": Speichere Satz " & i & "/" & UBound(rSw) + 0 & " in `" & Tbnm & "`"
setz:
  IF SammelInsert = 0 Or i = 1 Then
   csql.Append csql0
  End If ' SammelInsert = 0 Or i = 1 Then
...
#Else
 AnwPfad = App.Path
#END IF
 SELECT CASE MsgBox("FNr: " + CStr(ErrNumber) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in swsSpeichern/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume sql: If ErrNumber = 998 Then Resume sql Else Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.Path
 #END IF
 SELECT CASE MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in voplLaden/" + AnwPfad)
  Case vbAbort: Call MsgBox(" 2Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
fehler:
 ...
 AnwPfad = App.path
 #END IF
 Select Case MsgBox("FNr: " + CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in voplEinf/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox(" Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END Select
...
sql:
 ...
 For i = 1 to ubound(rVo)
  ...
  If i Mod 10 = 0 Then syscmd 4, pid & ": Speichere Satz " & i & "/" & UBound(rVo) + 0 & " in `" & Tbnm & "`"
setz:
  IF SammelInsert = 0 Or i = 1 Then
   csql.Append csql0
  End If ' SammelInsert = 0 Or i = 1 Then
...
#Else
 AnwPfad = App.Path
#END IF
 SELECT CASE MsgBox("FNr: " + CStr(ErrNumber) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in voplSpeichern/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume sql: If ErrNumber = 998 Then Resume sql Else Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
Public FUNCTION rLsDump()
 ...
 For i = 1 To UBound(rLs)
  ...
  Print #200, Left$("rLs(" & i & ").ArztID:" & String$(33, "."), 33) & rLs(i).ArztID
  Print #200, Left$("rLs(" & i & ").LabID:" & String$(33, "."), 33) & rLs(i).LabID
 ...
 Close #200
 zeigan ffadat
End Function ' laborysaetzeDump

Public Function laborysaetzeSpeichern(SammelInsert%, BezfSp%, Optional rAf&, Optional sfkco%, Optional tbnm="laborysaetze")
 Dim i&, rAFi&, Pid$, m%, sfnr%, altmode$, ErrD$, ErrN& ',sql0$
 Dim csql0 As New CString, csql As New CString
 Dim rs As New ADODB.recordset
 T1 = Timer
 ...
 Call csql0.AppVar(Array(" INSERT ", sqlIgnore, "INTO `" & LCase$(tbnm) & "` (DatID,Satzart,Satzlänge," & _
     "SatzlängeSchluss,VersionSatzb,ArztID,LabID,KBVPrüfnr,Zeichensatz,Kundenarztnr,Erstellungsdatum,Gesamtlänge,Arztnr," & _
     "Arztname,StraßePraxis,Arzt,LANR,PLZPraxis,OrtPraxis,Labor,StraßeLabor,PLZLabor,OrtLabor)     VALUES"))
sql:
 csql.m_Len = 0
 For i = 0 to ubound(rLs)
  If i Mod 10 = 0 Then syscmd 4, pid & ": Speichere Satz " & i & "/" & UBound(rLs) + 0 & " in `" & Tbnm & "`"
setz:
  IF SammelInsert = 0 Or i = 0 Then
   csql.Append csql0
  End If ' SammelInsert = 0 Or i = 0 Then
  csql.AppVar Array("(" , rLs(i).DatID, ",'" , rLs(i).Satzart, "','" , rLs(i).Satzlänge, "','" , rLs(i).SatzlängeSchluss, "','" , rLs(i).VersionSatzb, "'," , rLs(i).ArztID, "," , rLs(i).LabID, ",'" , rLs(i).KBVPrüfnr, "','" ,  _
   rLs(i).Zeichensatz, "','" , rLs(i).Kundenarztnr, "'," , DatFor_k(rLs(i).Erstellungsdatum), ",'" , rLs(i).Gesamtlänge, "','" , rLs(i).Arztnr, "','" , rLs(i).Arztname, "','" ,  _
...
sfnr = sfnr + 1
If sfnr > 10 then 
 Lese.Ausgeb sfnr & " Fehler in ""laborysaetzeSpeichern()"" bei Pat. " & rNa(0).Pat_id & ", gebe auf (ErrDes: " & ErrDescr & ")", True
 sfnr = 0
 Resume Next
End if ' sfnr > 10
IF ErrNumber = -2147217900 AND (InStrB(ErrDescr, "Doppelter Eintrag") <> 0 Or InStrB(ErrDescr, "Duplicate") <> 0) Then
...
ElseIf ErrNumber = -2147217833 OR InStrB(ErrDescr, "Daten zu lang") <> 0 OR InStrB(ErrDescr, "Data too long") <> 0 THEN
 ...
 for k = iif(SammelInsert<>0,0,i) to iif(SammelInsert<>0,ubound(rLs),i)
  ...
  IF Len(rLs(k).KBVPrüfnr) > maxi(4) THEN maxi(4) = Len(rLs(k).KBVPrüfnr)
  IF Len(rLs(k).Zeichensatz) > maxi(5) THEN maxi(5) = Len(rLs(k).Zeichensatz)
  IF Len(rLs(k).Kundenarztnr) > maxi(6) THEN maxi(6) = Len(rLs(k).Kundenarztnr)
  IF Len(rLs(k).Gesamtlänge) > maxi(7) THEN maxi(7) = Len(rLs(k).Gesamtlänge)
  IF Len(rLs(k).Arztnr) > maxi(8) THEN maxi(8) = Len(rLs(k).Arztnr)
  IF Len(rLs(k).Arztname) > maxi(9) THEN maxi(9) = Len(rLs(k).Arztname)
  IF Len(rLs(k).StraßePraxis) > maxi(10) THEN maxi(10) = Len(rLs(k).StraßePraxis)
  IF Len(rLs(k).Arzt) > maxi(11) THEN maxi(11) = Len(rLs(k).Arzt)
  IF Len(rLs(k).LANR) > maxi(12) THEN maxi(12) = Len(rLs(k).LANR)
  IF Len(rLs(k).PLZPraxis) > maxi(13) THEN maxi(13) = Len(rLs(k).PLZPraxis)
  IF Len(rLs(k).OrtPraxis) > maxi(14) THEN maxi(14) = Len(rLs(k).OrtPraxis)
  IF Len(rLs(k).Labor) > maxi(15) THEN maxi(15) = Len(rLs(k).Labor)
  IF Len(rLs(k).StraßeLabor) > maxi(16) THEN maxi(16) = Len(rLs(k).StraßeLabor)
  IF Len(rLs(k).PLZLabor) > maxi(17) THEN maxi(17) = Len(rLs(k).PLZLabor)
  IF Len(rLs(k).OrtLabor) > maxi(18) THEN maxi(18) = Len(rLs(k).OrtLabor)
 next k
 nochmal:
 SET rsc = New ADODB.Recordset
 SET rsc = DBCnOSchema(adSchemaColumns, Array(Empty, Empty, LCase$(tbnm), Empty))
    ...
    IF maxL > 0 THEN
     For k = IIf(SammelInsert <> 0,0, i) To IIf(SammelInsert <> 0,ubound(rLs), i)
      SELECT CASE m
       ...
       Case 4: Lese.Ausgeb "   Verkürze Inhalt von rLs.KBVPrüfnr: '" & rLs(k).KBVPrüfnr & "' -> '" & Left$(rLs(k).KBVPrüfnr, maxL)  & "'",true : rLs(k).KBVPrüfnr = Left$(rLs(k).KBVPrüfnr, maxL)
       Case 5: Lese.Ausgeb "   Verkürze Inhalt von rLs.Zeichensatz: '" & rLs(k).Zeichensatz & "' -> '" & Left$(rLs(k).Zeichensatz, maxL)  & "'",true : rLs(k).Zeichensatz = Left$(rLs(k).Zeichensatz, maxL)
       Case 6: Lese.Ausgeb "   Verkürze Inhalt von rLs.Kundenarztnr: '" & rLs(k).Kundenarztnr & "' -> '" & Left$(rLs(k).Kundenarztnr, maxL)  & "'",true : rLs(k).Kundenarztnr = Left$(rLs(k).Kundenarztnr, maxL)
       Case 7: Lese.Ausgeb "   Verkürze Inhalt von rLs.Gesamtlänge: '" & rLs(k).Gesamtlänge & "' -> '" & Left$(rLs(k).Gesamtlänge, maxL)  & "'",true : rLs(k).Gesamtlänge = Left$(rLs(k).Gesamtlänge, maxL)
       Case 8: Lese.Ausgeb "   Verkürze Inhalt von rLs.Arztnr: '" & rLs(k).Arztnr & "' -> '" & Left$(rLs(k).Arztnr, maxL)  & "'",true : rLs(k).Arztnr = Left$(rLs(k).Arztnr, maxL)
       Case 9: Lese.Ausgeb "   Verkürze Inhalt von rLs.Arztname: '" & rLs(k).Arztname & "' -> '" & Left$(rLs(k).Arztname, maxL)  & "'",true : rLs(k).Arztname = Left$(rLs(k).Arztname, maxL)
       Case 10: Lese.Ausgeb "   Verkürze Inhalt von rLs.StraßePraxis: '" & rLs(k).StraßePraxis & "' -> '" & Left$(rLs(k).StraßePraxis, maxL)  & "'",true : rLs(k).StraßePraxis = Left$(rLs(k).StraßePraxis, maxL)
       Case 11: Lese.Ausgeb "   Verkürze Inhalt von rLs.Arzt: '" & rLs(k).Arzt & "' -> '" & Left$(rLs(k).Arzt, maxL)  & "'",true : rLs(k).Arzt = Left$(rLs(k).Arzt, maxL)
       Case 12: Lese.Ausgeb "   Verkürze Inhalt von rLs.LANR: '" & rLs(k).LANR & "' -> '" & Left$(rLs(k).LANR, maxL)  & "'",true : rLs(k).LANR = Left$(rLs(k).LANR, maxL)
       Case 13: Lese.Ausgeb "   Verkürze Inhalt von rLs.PLZPraxis: '" & rLs(k).PLZPraxis & "' -> '" & Left$(rLs(k).PLZPraxis, maxL)  & "'",true : rLs(k).PLZPraxis = Left$(rLs(k).PLZPraxis, maxL)
       Case 14: Lese.Ausgeb "   Verkürze Inhalt von rLs.OrtPraxis: '" & rLs(k).OrtPraxis & "' -> '" & Left$(rLs(k).OrtPraxis, maxL)  & "'",true : rLs(k).OrtPraxis = Left$(rLs(k).OrtPraxis, maxL)
       Case 15: Lese.Ausgeb "   Verkürze Inhalt von rLs.Labor: '" & rLs(k).Labor & "' -> '" & Left$(rLs(k).Labor, maxL)  & "'",true : rLs(k).Labor = Left$(rLs(k).Labor, maxL)
       Case 16: Lese.Ausgeb "   Verkürze Inhalt von rLs.StraßeLabor: '" & rLs(k).StraßeLabor & "' -> '" & Left$(rLs(k).StraßeLabor, maxL)  & "'",true : rLs(k).StraßeLabor = Left$(rLs(k).StraßeLabor, maxL)
       Case 17: Lese.Ausgeb "   Verkürze Inhalt von rLs.PLZLabor: '" & rLs(k).PLZLabor & "' -> '" & Left$(rLs(k).PLZLabor, maxL)  & "'",true : rLs(k).PLZLabor = Left$(rLs(k).PLZLabor, maxL)
       Case 18: Lese.Ausgeb "   Verkürze Inhalt von rLs.OrtLabor: '" & rLs(k).OrtLabor & "' -> '" & Left$(rLs(k).OrtLabor, maxL)  & "'",true : rLs(k).OrtLabor = Left$(rLs(k).OrtLabor, maxL)
      END SELECT
     Next
    elseif maxl < 0 THEN
     goto nochmal
...
#Else
 AnwPfad = App.Path
#END IF
 SELECT CASE MsgBox("FNr: " + CStr(ErrNumber) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in laborysaetzeSpeichern/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume sql: If ErrNumber = 998 Then Resume sql Else Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
End FUNCTION ' laborysaetzeSpeichern
...
Public FUNCTION rLgDump()
 ...
 Close #200
 zeigan ffadat
End Function ' laboryeingelDump

 ' in LaborDirektImport
Public Function laboryeingelSpeichern(SammelInsert%, BezfSp%, Optional rAf&, Optional sfkco%, Optional tbnm="laboryeingel")
 Dim i&, rAFi&, Pid$, m%, sfnr%, altmode$, ErrD$, ErrN& ',sql0$
 Dim csql0 As New CString, csql As New CString
 Dim rs As New ADODB.recordset
 T1 = Timer
...
sql:
 csql.m_Len = 0
 For i = 1 to ubound(rLg)
  If i Mod 10 = 0 Then syscmd 4, pid & ": Speichere Satz " & i & "/" & UBound(rLg) + 0 & " in `" & Tbnm & "`"
setz:
  IF SammelInsert = 0 Or i = 1 Then
   csql.Append csql0
  End If ' SammelInsert = 0 Or i = 1 Then
...
sfnr = sfnr + 1
If sfnr > 10 then 
 Lese.Ausgeb sfnr & " Fehler in ""laboryeingelSpeichern()"" bei Pat. " & rNa(0).Pat_id & ", gebe auf (ErrDes: " & ErrDescr & ")", True
 sfnr = 0
 Resume Next
End if ' sfnr > 10
IF ErrNumber = -2147217900 AND (InStrB(ErrDescr, "Doppelter Eintrag") <> 0 Or InStrB(ErrDescr, "Duplicate") <> 0) Then
...
#Else
 AnwPfad = App.Path
#END IF
 SELECT CASE MsgBox("FNr: " + CStr(ErrNumber) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in laboryeingelSpeichern/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume sql: If ErrNumber = 998 Then Resume sql Else Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
End FUNCTION ' laboryeingelSpeichern
...
Public FUNCTION rLuDump()
 ...
 For i = 1 To UBound(rLu)
  Print #200, vbCrLf & "i: " & i
  Print #200, Left$("rLu(" & i & ").ID:" & String$(33, "."), 33) & rLu(i).ID
  Print #200, Left$("rLu(" & i & ").UsLfd:" & String$(33, "."), 33) & rLu(i).UsLfd
  ...
  Print #200, Left$("rLu(" & i & ").NVors2:" & String$(33, "."), 33) & "'" & rLu(i).NVors2 & "'"
  ...
  Print #200, Left$("rLu(" & i & ").Pat_id_0:" & String$(33, "."), 33) & "'" & rLu(i).Pat_id_0 & "'"
  Print #200, Left$("rLu(" & i & ").Pat_id_1:" & String$(33, "."), 33) & "'" & rLu(i).Pat_id_1 & "'"
  Print #200, Left$("rLu(" & i & ").Pat_id_2:" & String$(33, "."), 33) & "'" & rLu(i).Pat_id_2 & "'"
  Print #200, Left$("rLu(" & i & ").Pat_id_3:" & String$(33, "."), 33) & "'" & rLu(i).Pat_id_3 & "'"
  Print #200, Left$("rLu(" & i & ").Pat_id_4:" & String$(33, "."), 33) & "'" & rLu(i).Pat_id_4 & "'"
  Print #200, Left$("rLu(" & i & ").Pat_id_5:" & String$(33, "."), 33) & "'" & rLu(i).Pat_id_5 & "'"
  Print #200, Left$("rLu(" & i & ").Pat_id_6:" & String$(33, "."), 33) & "'" & rLu(i).Pat_id_6 & "'"
  Print #200, Left$("rLu(" & i & ").Pat_id_7:" & String$(33, "."), 33) & "'" & rLu(i).Pat_id_7 & "'"
  Print #200, Left$("rLu(" & i & ").ZeitpunktLaborneu:" & String$(33, "."), 33) & rLu(i).ZeitpunktLaborneu
  Print #200, Left$("rLu(" & i & ").Pat_id_Laborneu:" & String$(33, "."), 33) & "'" & rLu(i).Pat_id_Laborneu & "'"
  Print #200, Left$("rLu(" & i & ").verglichen:" & String$(33, "."), 33) & rLu(i).verglichen
  Print #200, Left$("rLu(" & i & ").AfN:" & String$(33, "."), 33) & rLu(i).AfN
  Print #200, Left$("rLu(" & i & ").z7:" & String$(33, "."), 33) & rLu(i).z7
  Print #200, Left$("rLu(" & i & ").SQL7:" & String$(33, "."), 33) & "'" & rLu(i).SQL7 & "'"
  Print #200, Left$("rLu(" & i & ").namsp:" & String$(33, "."), 33) & rLu(i).namsp
  Print #200, Left$("rLu(" & i & ").wertsp:" & String$(33, "."), 33) & rLu(i).wertsp
  Print #200, Left$("rLu(" & i & ").termsp:" & String$(33, "."), 33) & rLu(i).termsp
  Print #200, Left$("rLu(" & i & ").Termine:" & String$(33, "."), 33) & "'" & rLu(i).Termine & "'"
  Print #200, Left$("rLu(" & i & ").Pat_idUrsp:" & String$(33, "."), 33) & "'" & rLu(i).Pat_idUrsp & "'"
  Print #200, Left$("rLu(" & i & ").TM_Pat_id:" & String$(33, "."), 33) & rLu(i).TM_Pat_id
  Print #200, Left$("rLu(" & i & ").Spalte_16:" & String$(33, "."), 33) & rLu(i).Spalte_16
 Next i
 Close #200
 zeigan ffadat
End Function ' laboryusDump

Public Function laboryusSpeichern(SammelInsert%, BezfSp%, j&, Optional rAf&, Optional sfkco%, Optional tbnm="laboryus")
 Dim i&, rAFi&, Pid$, m%, sfnr%, altmode$, ErrD$, ErrN& ',sql0$
 Dim csql0 As New CString, csql As New CString
 Dim rs As New ADODB.recordset
 T1 = Timer
 ...
 Pid = rNa(0).Pat_id
 On Error GoTo fehler
 Call csql0.AppVar(Array(" INSERT ", sqlIgnore, "INTO `" & LCase$(tbnm) & "` (UsLfd,DatID,SatzID," & _
     "Satzart,Satzlänge,Auftragsnummer,Auftragsschlüssel,Eingang,Berichtsdatum,Pat_ID,Nachname,Vorname,GebDat," & _
     "Titel,NVorsatz,NVors2,BefArt,Abrechnungstyp,GebüOrd,Auftraggeber,Patienteninformation,Geschlecht,Pat_id_0," & _
     "Pat_id_1,Pat_id_2,Pat_id_3,Pat_id_4,Pat_id_5,Pat_id_6,Pat_id_7,ZeitpunktLaborneu,Pat_id_Laborneu,verglichen," & _
     "AfN,z7,SQL7,namsp,wertsp,termsp,Termine,Pat_idUrsp,TM_Pat_id,Spalte_16)        VALUES"))
sql:
 csql.m_Len = 0
 For i = j to j
  If i Mod 10 = 0 Then syscmd 4, pid & ": Speichere Satz " & i & "/" & UBound(rLu) + 0 & " in `" & Tbnm & "`"
setz:
  IF SammelInsert = 0 Or i = j Then
   csql.Append csql0
  End If ' SammelInsert = 0 Or i = j Then
  csql.AppVar Array("(" , rLu(i).UsLfd, "," , rLu(i).DatID, "," , rLu(i).SatzID, ",'" , rLu(i).Satzart, "','" , rLu(i).Satzlänge, "','" , rLu(i).Auftragsnummer, "','" , rLu(i).Auftragsschlüssel, "'," , DatFor_k(rLu(i).Eingang), "," , DatFor_k( _
   rLu(i).Berichtsdatum), "," , rLu(i).Pat_ID, ",'" , rLu(i).Nachname, "','" , rLu(i).Vorname, "'," , DatFor_k(rLu(i).GebDat), ",'" , rLu(i).Titel, "','" , rLu(i).NVorsatz, "','" ,  _
   rLu(i).NVors2, "','" , rLu(i).BefArt, "','" , rLu(i).Abrechnungstyp, "','" , rLu(i).GebüOrd, "','" , rLu(i).Auftraggeber, "','" , rLu(i).Patienteninformation, "','" , rLu(i).Geschlecht, "','" ,  _
   rLu(i).Pat_id_0, "','" , rLu(i).Pat_id_1, "','" , rLu(i).Pat_id_2, "','" , rLu(i).Pat_id_3, "','" , rLu(i).Pat_id_4, "','" , rLu(i).Pat_id_5, "','" , rLu(i).Pat_id_6, "','" ,  _
   rLu(i).Pat_id_7, "'," , DatFor_k(rLu(i).ZeitpunktLaborneu), ",'" , rLu(i).Pat_id_Laborneu, "'," , DatFor_k(rLu(i).verglichen), "," , rLu(i).AfN, "," , rLu(i).z7, ",'" , rLu(i).SQL7, "'," ,  _
   rLu(i).namsp, "," , rLu(i).wertsp, "," , rLu(i).termsp, ",'" , rLu(i).Termine, "','" , rLu(i).Pat_idUrsp, "'," , rLu(i).TM_Pat_id, "," , DatFor_k(rLu(i).Spalte_16), ")")
  ...
  IF SammelInsert = 0 OR i = j Then
    ...
    If ErrN Then
     If SammelInsert = 1 And ErrN = -2147217900 Then
      ...
      GoTo sql
     ElseIf InStrB(ErrD, "Duplicate") <> 0 Then
      rLu(i).ID = myEFrag("SELECT MAX(ID)+1 FROM `" & LCase$(tbnm) & "`", , DBCn).Fields(0)
      csql.m_Len = 0
      GoTo setz
     Else ' SammelInsert = 1 And ErrN = -2147217900 Then elseif
      Error ErrN
...
sfnr = sfnr + 1
If sfnr > 10 then 
 Lese.Ausgeb sfnr & " Fehler in ""laboryusSpeichern()"" bei Pat. " & rNa(0).Pat_id & ", gebe auf (ErrDes: " & ErrDescr & ")", True
 sfnr = 0
 Resume Next
End if ' sfnr > 10
IF ErrNumber = -2147217900 AND (InStrB(ErrDescr, "Doppelter Eintrag") <> 0 Or InStrB(ErrDescr, "Duplicate") <> 0) Then
...
ElseIf ErrNumber = -2147217833 OR InStrB(ErrDescr, "Daten zu lang") <> 0 OR InStrB(ErrDescr, "Data too long") <> 0 THEN
 ...
 for k = iif(SammelInsert<>0,j,i) to iif(SammelInsert<>0,j,i)
  ...
  IF Len(rLu(k).Nachname) > maxi(4) THEN maxi(4) = Len(rLu(k).Nachname)
  IF Len(rLu(k).Vorname) > maxi(5) THEN maxi(5) = Len(rLu(k).Vorname)
  IF Len(rLu(k).Titel) > maxi(6) THEN maxi(6) = Len(rLu(k).Titel)
  IF Len(rLu(k).NVorsatz) > maxi(7) THEN maxi(7) = Len(rLu(k).NVorsatz)
  IF Len(rLu(k).NVors2) > maxi(8) THEN maxi(8) = Len(rLu(k).NVors2)
  IF Len(rLu(k).BefArt) > maxi(9) THEN maxi(9) = Len(rLu(k).BefArt)
  IF Len(rLu(k).Abrechnungstyp) > maxi(10) THEN maxi(10) = Len(rLu(k).Abrechnungstyp)
  IF Len(rLu(k).GebüOrd) > maxi(11) THEN maxi(11) = Len(rLu(k).GebüOrd)
  IF Len(rLu(k).Auftraggeber) > maxi(12) THEN maxi(12) = Len(rLu(k).Auftraggeber)
  ...
  IF Len(rLu(k).Pat_id_0) > maxi(15) THEN maxi(15) = Len(rLu(k).Pat_id_0)
  IF Len(rLu(k).Pat_id_1) > maxi(16) THEN maxi(16) = Len(rLu(k).Pat_id_1)
  IF Len(rLu(k).Pat_id_2) > maxi(17) THEN maxi(17) = Len(rLu(k).Pat_id_2)
  IF Len(rLu(k).Pat_id_3) > maxi(18) THEN maxi(18) = Len(rLu(k).Pat_id_3)
  IF Len(rLu(k).Pat_id_4) > maxi(19) THEN maxi(19) = Len(rLu(k).Pat_id_4)
  IF Len(rLu(k).Pat_id_5) > maxi(20) THEN maxi(20) = Len(rLu(k).Pat_id_5)
  IF Len(rLu(k).Pat_id_6) > maxi(21) THEN maxi(21) = Len(rLu(k).Pat_id_6)
  IF Len(rLu(k).Pat_id_7) > maxi(22) THEN maxi(22) = Len(rLu(k).Pat_id_7)
  IF Len(rLu(k).Pat_id_Laborneu) > maxi(23) THEN maxi(23) = Len(rLu(k).Pat_id_Laborneu)
  IF Len(rLu(k).SQL7) > maxi(24) THEN maxi(24) = Len(rLu(k).SQL7)
  IF Len(rLu(k).Termine) > maxi(25) THEN maxi(25) = Len(rLu(k).Termine)
  IF Len(rLu(k).Pat_idUrsp) > maxi(26) THEN maxi(26) = Len(rLu(k).Pat_idUrsp)
 next k
 nochmal:
 SET rsc = New ADODB.Recordset
 SET rsc = DBCnOSchema(adSchemaColumns, Array(Empty, Empty, LCase$(tbnm), Empty))
    ...
    IF maxL > 0 THEN
     For k = IIf(SammelInsert <> 0,j, i) To IIf(SammelInsert <> 0,j, i)
      SELECT CASE m
       ...
       Case 4: Lese.Ausgeb "   Verkürze Inhalt von rLu.Nachname: '" & rLu(k).Nachname & "' -> '" & Left$(rLu(k).Nachname, maxL)  & "'",true : rLu(k).Nachname = Left$(rLu(k).Nachname, maxL)
       Case 5: Lese.Ausgeb "   Verkürze Inhalt von rLu.Vorname: '" & rLu(k).Vorname & "' -> '" & Left$(rLu(k).Vorname, maxL)  & "'",true : rLu(k).Vorname = Left$(rLu(k).Vorname, maxL)
       Case 6: Lese.Ausgeb "   Verkürze Inhalt von rLu.Titel: '" & rLu(k).Titel & "' -> '" & Left$(rLu(k).Titel, maxL)  & "'",true : rLu(k).Titel = Left$(rLu(k).Titel, maxL)
       Case 7: Lese.Ausgeb "   Verkürze Inhalt von rLu.NVorsatz: '" & rLu(k).NVorsatz & "' -> '" & Left$(rLu(k).NVorsatz, maxL)  & "'",true : rLu(k).NVorsatz = Left$(rLu(k).NVorsatz, maxL)
       Case 8: Lese.Ausgeb "   Verkürze Inhalt von rLu.NVors2: '" & rLu(k).NVors2 & "' -> '" & Left$(rLu(k).NVors2, maxL)  & "'",true : rLu(k).NVors2 = Left$(rLu(k).NVors2, maxL)
       Case 9: Lese.Ausgeb "   Verkürze Inhalt von rLu.BefArt: '" & rLu(k).BefArt & "' -> '" & Left$(rLu(k).BefArt, maxL)  & "'",true : rLu(k).BefArt = Left$(rLu(k).BefArt, maxL)
       Case 10: Lese.Ausgeb "   Verkürze Inhalt von rLu.Abrechnungstyp: '" & rLu(k).Abrechnungstyp & "' -> '" & Left$(rLu(k).Abrechnungstyp, maxL)  & "'",true : rLu(k).Abrechnungstyp = Left$(rLu(k).Abrechnungstyp, maxL)
       Case 11: Lese.Ausgeb "   Verkürze Inhalt von rLu.GebüOrd: '" & rLu(k).GebüOrd & "' -> '" & Left$(rLu(k).GebüOrd, maxL)  & "'",true : rLu(k).GebüOrd = Left$(rLu(k).GebüOrd, maxL)
       Case 12: Lese.Ausgeb "   Verkürze Inhalt von rLu.Auftraggeber: '" & rLu(k).Auftraggeber & "' -> '" & Left$(rLu(k).Auftraggeber, maxL)  & "'",true : rLu(k).Auftraggeber = Left$(rLu(k).Auftraggeber, maxL)
       Case 13: Lese.Ausgeb "   Verkürze Inhalt von rLu.Patienteninformation: '" & rLu(k).Patienteninformation & "' -> '" & Left$(rLu(k).Patienteninformation, maxL)  & "'",true : rLu(k).Patienteninformation = Left$(rLu(k).Patienteninformation, maxL)
       Case 14: Lese.Ausgeb "   Verkürze Inhalt von rLu.Geschlecht: '" & rLu(k).Geschlecht & "' -> '" & Left$(rLu(k).Geschlecht, maxL)  & "'",true : rLu(k).Geschlecht = Left$(rLu(k).Geschlecht, maxL)
       Case 15: Lese.Ausgeb "   Verkürze Inhalt von rLu.Pat_id_0: '" & rLu(k).Pat_id_0 & "' -> '" & Left$(rLu(k).Pat_id_0, maxL)  & "'",true : rLu(k).Pat_id_0 = Left$(rLu(k).Pat_id_0, maxL)
       Case 16: Lese.Ausgeb "   Verkürze Inhalt von rLu.Pat_id_1: '" & rLu(k).Pat_id_1 & "' -> '" & Left$(rLu(k).Pat_id_1, maxL)  & "'",true : rLu(k).Pat_id_1 = Left$(rLu(k).Pat_id_1, maxL)
       Case 17: Lese.Ausgeb "   Verkürze Inhalt von rLu.Pat_id_2: '" & rLu(k).Pat_id_2 & "' -> '" & Left$(rLu(k).Pat_id_2, maxL)  & "'",true : rLu(k).Pat_id_2 = Left$(rLu(k).Pat_id_2, maxL)
       Case 18: Lese.Ausgeb "   Verkürze Inhalt von rLu.Pat_id_3: '" & rLu(k).Pat_id_3 & "' -> '" & Left$(rLu(k).Pat_id_3, maxL)  & "'",true : rLu(k).Pat_id_3 = Left$(rLu(k).Pat_id_3, maxL)
       Case 19: Lese.Ausgeb "   Verkürze Inhalt von rLu.Pat_id_4: '" & rLu(k).Pat_id_4 & "' -> '" & Left$(rLu(k).Pat_id_4, maxL)  & "'",true : rLu(k).Pat_id_4 = Left$(rLu(k).Pat_id_4, maxL)
       Case 20: Lese.Ausgeb "   Verkürze Inhalt von rLu.Pat_id_5: '" & rLu(k).Pat_id_5 & "' -> '" & Left$(rLu(k).Pat_id_5, maxL)  & "'",true : rLu(k).Pat_id_5 = Left$(rLu(k).Pat_id_5, maxL)
       Case 21: Lese.Ausgeb "   Verkürze Inhalt von rLu.Pat_id_6: '" & rLu(k).Pat_id_6 & "' -> '" & Left$(rLu(k).Pat_id_6, maxL)  & "'",true : rLu(k).Pat_id_6 = Left$(rLu(k).Pat_id_6, maxL)
       Case 22: Lese.Ausgeb "   Verkürze Inhalt von rLu.Pat_id_7: '" & rLu(k).Pat_id_7 & "' -> '" & Left$(rLu(k).Pat_id_7, maxL)  & "'",true : rLu(k).Pat_id_7 = Left$(rLu(k).Pat_id_7, maxL)
       Case 23: Lese.Ausgeb "   Verkürze Inhalt von rLu.Pat_id_Laborneu: '" & rLu(k).Pat_id_Laborneu & "' -> '" & Left$(rLu(k).Pat_id_Laborneu, maxL)  & "'",true : rLu(k).Pat_id_Laborneu = Left$(rLu(k).Pat_id_Laborneu, maxL)
       Case 24: Lese.Ausgeb "   Verkürze Inhalt von rLu.SQL7: '" & rLu(k).SQL7 & "' -> '" & Left$(rLu(k).SQL7, maxL)  & "'",true : rLu(k).SQL7 = Left$(rLu(k).SQL7, maxL)
       Case 25: Lese.Ausgeb "   Verkürze Inhalt von rLu.Termine: '" & rLu(k).Termine & "' -> '" & Left$(rLu(k).Termine, maxL)  & "'",true : rLu(k).Termine = Left$(rLu(k).Termine, maxL)
       Case 26: Lese.Ausgeb "   Verkürze Inhalt von rLu.Pat_idUrsp: '" & rLu(k).Pat_idUrsp & "' -> '" & Left$(rLu(k).Pat_idUrsp, maxL)  & "'",true : rLu(k).Pat_idUrsp = Left$(rLu(k).Pat_idUrsp, maxL)
      END SELECT
     Next
    elseif maxl < 0 THEN
     goto nochmal
...
#Else
 AnwPfad = App.Path
#END IF
 SELECT CASE MsgBox("FNr: " + CStr(ErrNumber) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in laboryusSpeichern/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume sql: If ErrNumber = 998 Then Resume sql Else Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
End FUNCTION ' laboryusSpeichern
...
Public FUNCTION rLoDump()
 ...
 For i = 1 To UBound(rLo)
  Print #200, vbCrLf & "i: " & i
  Print #200, Left$("rLo(" & i & ").ID:" & String$(33, "."), 33) & rLo(i).ID
  Print #200, Left$("rLo(" & i & ").UsID:" & String$(33, "."), 33) & rLo(i).UsID
  Print #200, Left$("rLo(" & i & ").NBID:" & String$(33, "."), 33) & rLo(i).NBID
  ...
  Print #200, Left$("rLo(" & i & ").KommID:" & String$(33, "."), 33) & rLo(i).KommID
  Print #200, Left$("rLo(" & i & ").ErklID:" & String$(33, "."), 33) & rLo(i).ErklID
  Print #200, Left$("rLo(" & i & ").HinwID:" & String$(33, "."), 33) & rLo(i).HinwID
  Print #200, Left$("rLo(" & i & ").QSpezID:" & String$(33, "."), 33) & rLo(i).QSpezID
  Print #200, Left$("rLo(" & i & ").Keimzahl:" & String$(33, "."), 33) & "'" & rLo(i).Keimzahl & "'"
  Print #200, Left$("rLo(" & i & ").abrd:" & String$(33, "."), 33) & "'" & rLo(i).abrd & "'"
  Print #200, Left$("rLo(" & i & ").Hinweise:" & String$(33, "."), 33) & "'" & rLo(i).Hinweise & "'"
  Print #200, Left$("rLo(" & i & ").fICD:" & String$(33, "."), 33) & "'" & rLo(i).fICD & "'"
  Print #200, Left$("rLo(" & i & ").hinwsp:" & String$(33, "."), 33) & rLo(i).hinwsp
  Print #200, Left$("rLo(" & i & ").termsp:" & String$(33, "."), 33) & rLo(i).termsp
  Print #200, Left$("rLo(" & i & ").fICDsp:" & String$(33, "."), 33) & rLo(i).fICDsp
  Print #200, Left$("rLo(" & i & ").Vorwert_1:" & String$(33, "."), 33) & "'" & rLo(i).Vorwert_1 & "'"
  Print #200, Left$("rLo(" & i & ").Vorwert_2:" & String$(33, "."), 33) & "'" & rLo(i).Vorwert_2 & "'"
  Print #200, Left$("rLo(" & i & ").QSpez:" & String$(33, "."), 33) & "'" & rLo(i).QSpez & "'"
 Next i
 Close #200
 zeigan ffadat
End Function ' laborybaktDump

Public Function laborybaktSpeichern(SammelInsert%, BezfSp%, Optional rAf&, Optional sfkco%, Optional tbnm="laborybakt")
 Dim i&, rAFi&, Pid$, m%, sfnr%, altmode$, ErrD$, ErrN& ',sql0$
 Dim csql0 As New CString, csql As New CString
 Dim rs As New ADODB.recordset
 T1 = Timer
 ...
 Pid = rNa(0).Pat_id
 On Error GoTo fehler
 Call csql0.AppVar(Array(" INSERT ", sqlIgnore, "INTO `" & LCase$(tbnm) & "` (UsID,NBID,Verf," & _
     "KuQu,Quelle,AbnDat,KommID,ErklID,HinwID,QSpezID,Keimzahl,abrd,Hinweise," & _
     "fICD,hinwsp,termsp,fICDsp,Vorwert_1,Vorwert_2,QSpez)             VALUES"))
sql:
 csql.m_Len = 0
 For i = 1 to ubound(rLo)
  If i Mod 10 = 0 Then syscmd 4, pid & ": Speichere Satz " & i & "/" & UBound(rLo) + 0 & " in `" & Tbnm & "`"
setz:
  IF SammelInsert = 0 Or i = 1 Then
   csql.Append csql0
  End If ' SammelInsert = 0 Or i = 1 Then
  csql.AppVar Array("(" , rLo(i).UsID, "," , rLo(i).NBID, ",'" , rLo(i).Verf, "','" , rLo(i).KuQu, "','" , rLo(i).Quelle, "'," , DatFor_k(rLo(i).AbnDat), "," , rLo(i).KommID, "," , rLo(i).ErklID, "," , rLo(i).HinwID, "," ,  _
   rLo(i).QSpezID, ",'" , rLo(i).Keimzahl, "','" , rLo(i).abrd, "','" , rLo(i).Hinweise, "','" , rLo(i).fICD, "'," , rLo(i).hinwsp, "," , rLo(i).termsp, "," , rLo(i).fICDsp, ",'" ,  _
   rLo(i).Vorwert_1, "','" , rLo(i).Vorwert_2, "','" , rLo(i).QSpez, "')")
  ...
  IF SammelInsert = 0 OR i = ubound(rLo) Then
    ...
    If ErrN Then
     If SammelInsert = 1 And ErrN = -2147217900 Then
      ...
      GoTo sql
     ElseIf InStrB(ErrD, "Duplicate") <> 0 Then
      rLo(i).ID = myEFrag("SELECT MAX(ID)+1 FROM `" & LCase$(tbnm) & "`", , DBCn).Fields(0)
      csql.m_Len = 0
      GoTo setz
     Else ' SammelInsert = 1 And ErrN = -2147217900 Then elseif
      Error ErrN
...
sfnr = sfnr + 1
If sfnr > 10 then 
 Lese.Ausgeb sfnr & " Fehler in ""laborybaktSpeichern()"" bei Pat. " & rNa(0).Pat_id & ", gebe auf (ErrDes: " & ErrDescr & ")", True
 sfnr = 0
 Resume Next
End if ' sfnr > 10
IF ErrNumber = -2147217900 AND (InStrB(ErrDescr, "Doppelter Eintrag") <> 0 Or InStrB(ErrDescr, "Duplicate") <> 0) Then
...
ElseIf ErrNumber = -2147217833 OR InStrB(ErrDescr, "Daten zu lang") <> 0 OR InStrB(ErrDescr, "Data too long") <> 0 THEN
 ...
 for k = iif(SammelInsert<>0,1,i) to iif(SammelInsert<>0,ubound(rLo),i)
  ...
  IF Len(rLo(k).Keimzahl) > maxi(3) THEN maxi(3) = Len(rLo(k).Keimzahl)
  IF Len(rLo(k).abrd) > maxi(4) THEN maxi(4) = Len(rLo(k).abrd)
  IF Len(rLo(k).Hinweise) > maxi(5) THEN maxi(5) = Len(rLo(k).Hinweise)
  IF Len(rLo(k).fICD) > maxi(6) THEN maxi(6) = Len(rLo(k).fICD)
  IF Len(rLo(k).Vorwert_1) > maxi(7) THEN maxi(7) = Len(rLo(k).Vorwert_1)
  IF Len(rLo(k).Vorwert_2) > maxi(8) THEN maxi(8) = Len(rLo(k).Vorwert_2)
  IF Len(rLo(k).QSpez) > maxi(9) THEN maxi(9) = Len(rLo(k).QSpez)
 next k
 nochmal:
 SET rsc = New ADODB.Recordset
 SET rsc = DBCnOSchema(adSchemaColumns, Array(Empty, Empty, LCase$(tbnm), Empty))
    ...
    IF maxL > 0 THEN
     For k = IIf(SammelInsert <> 0,1, i) To IIf(SammelInsert <> 0,ubound(rLo), i)
      SELECT CASE m
       ...
       Case 3: Lese.Ausgeb "   Verkürze Inhalt von rLo.Keimzahl: '" & rLo(k).Keimzahl & "' -> '" & Left$(rLo(k).Keimzahl, maxL)  & "'",true : rLo(k).Keimzahl = Left$(rLo(k).Keimzahl, maxL)
       Case 4: Lese.Ausgeb "   Verkürze Inhalt von rLo.abrd: '" & rLo(k).abrd & "' -> '" & Left$(rLo(k).abrd, maxL)  & "'",true : rLo(k).abrd = Left$(rLo(k).abrd, maxL)
       Case 5: Lese.Ausgeb "   Verkürze Inhalt von rLo.Hinweise: '" & rLo(k).Hinweise & "' -> '" & Left$(rLo(k).Hinweise, maxL)  & "'",true : rLo(k).Hinweise = Left$(rLo(k).Hinweise, maxL)
       Case 6: Lese.Ausgeb "   Verkürze Inhalt von rLo.fICD: '" & rLo(k).fICD & "' -> '" & Left$(rLo(k).fICD, maxL)  & "'",true : rLo(k).fICD = Left$(rLo(k).fICD, maxL)
       Case 7: Lese.Ausgeb "   Verkürze Inhalt von rLo.Vorwert_1: '" & rLo(k).Vorwert_1 & "' -> '" & Left$(rLo(k).Vorwert_1, maxL)  & "'",true : rLo(k).Vorwert_1 = Left$(rLo(k).Vorwert_1, maxL)
       Case 8: Lese.Ausgeb "   Verkürze Inhalt von rLo.Vorwert_2: '" & rLo(k).Vorwert_2 & "' -> '" & Left$(rLo(k).Vorwert_2, maxL)  & "'",true : rLo(k).Vorwert_2 = Left$(rLo(k).Vorwert_2, maxL)
       Case 9: Lese.Ausgeb "   Verkürze Inhalt von rLo.QSpez: '" & rLo(k).QSpez & "' -> '" & Left$(rLo(k).QSpez, maxL)  & "'",true : rLo(k).QSpez = Left$(rLo(k).QSpez, maxL)
      END SELECT
     Next
    elseif maxl < 0 THEN
     goto nochmal
...
#Else
 AnwPfad = App.Path
#END IF
 SELECT CASE MsgBox("FNr: " + CStr(ErrNumber) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in laborybaktSpeichern/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume sql: If ErrNumber = 998 Then Resume sql Else Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
End FUNCTION ' laborybaktSpeichern
...
Public FUNCTION rLwDump()
 ...
 For i = 1 To UBound(rLw)
  Print #200, vbCrLf & "i: " & i
  Print #200, Left$("rLw(" & i & ").ID:" & String$(33, "."), 33) & rLw(i).ID
  Print #200, Left$("rLw(" & i & ").UsID:" & String$(33, "."), 33) & rLw(i).UsID
  Print #200, Left$("rLw(" & i & ").BaktID:" & String$(33, "."), 33) & rLw(i).BaktID
  Print #200, Left$("rLw(" & i & ").NBID:" & String$(33, "."), 33) & rLw(i).NBID
  Print #200, Left$("rLw(" & i & ").Abkü:" & String$(33, "."), 33) & "'" & rLw(i).Abkü & "'"
  Print #200, Left$("rLw(" & i & ").Langtext:" & String$(33, "."), 33) & "'" & rLw(i).Langtext & "'"
  Print #200, Left$("rLw(" & i & ").KuQu:" & String$(33, "."), 33) & "'" & rLw(i).KuQu & "'"
  ...
  Print #200, Left$("rLw(" & i & ").KommID:" & String$(33, "."), 33) & rLw(i).KommID
  Print #200, Left$("rLw(" & i & ").Teststatus:" & String$(33, "."), 33) & "'" & rLw(i).Teststatus & "'"
  Print #200, Left$("rLw(" & i & ").ErklID:" & String$(33, "."), 33) & rLw(i).ErklID
  Print #200, Left$("rLw(" & i & ").HinwID:" & String$(33, "."), 33) & rLw(i).HinwID
  Print #200, Left$("rLw(" & i & ").QSpezID:" & String$(33, "."), 33) & rLw(i).QSpezID
  Print #200, Left$("rLw(" & i & ").abrd:" & String$(33, "."), 33) & "'" & rLw(i).abrd & "'"
  Print #200, Left$("rLw(" & i & ").Hinweise:" & String$(33, "."), 33) & "'" & rLw(i).Hinweise & "'"
  Print #200, Left$("rLw(" & i & ").fICD:" & String$(33, "."), 33) & "'" & rLw(i).fICD & "'"
  Print #200, Left$("rLw(" & i & ").hinwsp:" & String$(33, "."), 33) & rLw(i).hinwsp
  Print #200, Left$("rLw(" & i & ").termsp:" & String$(33, "."), 33) & rLw(i).termsp
  Print #200, Left$("rLw(" & i & ").fICDsp:" & String$(33, "."), 33) & rLw(i).fICDsp
  Print #200, Left$("rLw(" & i & ").Vorwert_1:" & String$(33, "."), 33) & "'" & rLw(i).Vorwert_1 & "'"
  Print #200, Left$("rLw(" & i & ").Vorwert_2:" & String$(33, "."), 33) & "'" & rLw(i).Vorwert_2 & "'"
 Next i
 Close #200
 zeigan ffadat
End Function ' laborywertDump

Public Function laborywertSpeichern(SammelInsert%, BezfSp%, Optional rAf&, Optional sfkco%, Optional tbnm="laborywert")
 Dim i&, rAFi&, Pid$, m%, sfnr%, altmode$, ErrD$, ErrN& ',sql0$
 Dim csql0 As New CString, csql As New CString
 Dim rs As New ADODB.recordset
 T1 = Timer
 ...
 Pid = rNa(0).Pat_id
 On Error GoTo fehler
 Call csql0.AppVar(Array(" INSERT ", sqlIgnore, "INTO `" & LCase$(tbnm) & "` (UsID,BaktID,NBID," & _
     "Abkü,Langtext,KuQu,Quelle,AbnDat,Wert,Einheit,Grenzwerti,KommID,Teststatus," & _
     "ErklID,HinwID,QSpezID,abrd,Hinweise,fICD,hinwsp,termsp,fICDsp,Vorwert_1," & _
     "Vorwert_2)             VALUES"))
sql:
 csql.m_Len = 0
 For i = 1 to ubound(rLw)
  If i Mod 10 = 0 Then syscmd 4, pid & ": Speichere Satz " & i & "/" & UBound(rLw) + 0 & " in `" & Tbnm & "`"
setz:
  IF SammelInsert = 0 Or i = 1 Then
   csql.Append csql0
  End If ' SammelInsert = 0 Or i = 1 Then
  csql.AppVar Array("(" , rLw(i).UsID, "," , rLw(i).BaktID, "," , rLw(i).NBID, ",'" , rLw(i).Abkü, "','" , rLw(i).Langtext, "','" , rLw(i).KuQu, "','" , rLw(i).Quelle, "'," , DatFor_k(rLw(i).AbnDat), ",'" ,  _
   rLw(i).Wert, "','" , rLw(i).Einheit, "','" , rLw(i).Grenzwerti, "'," , rLw(i).KommID, ",'" , rLw(i).Teststatus, "'," , rLw(i).ErklID, "," , rLw(i).HinwID, "," , rLw(i).QSpezID, ",'" , rLw(i).abrd, "','" ,  _
   rLw(i).Hinweise, "','" , rLw(i).fICD, "'," , rLw(i).hinwsp, "," , rLw(i).termsp, "," , rLw(i).fICDsp, ",'" , rLw(i).Vorwert_1, "','" , rLw(i).Vorwert_2, "')")
  ...
  IF SammelInsert = 0 OR i = ubound(rLw) Then
    ...
    If ErrN Then
     If SammelInsert = 1 And ErrN = -2147217900 Then
      ...
      GoTo sql
     ElseIf InStrB(ErrD, "Duplicate") <> 0 Then
      rLw(i).ID = myEFrag("SELECT MAX(ID)+1 FROM `" & LCase$(tbnm) & "`", , DBCn).Fields(0)
      csql.m_Len = 0
      GoTo setz
     Else ' SammelInsert = 1 And ErrN = -2147217900 Then elseif
      Error ErrN
...
sfnr = sfnr + 1
If sfnr > 10 then 
 Lese.Ausgeb sfnr & " Fehler in ""laborywertSpeichern()"" bei Pat. " & rNa(0).Pat_id & ", gebe auf (ErrDes: " & ErrDescr & ")", True
 sfnr = 0
 Resume Next
End if ' sfnr > 10
IF ErrNumber = -2147217900 AND (InStrB(ErrDescr, "Doppelter Eintrag") <> 0 Or InStrB(ErrDescr, "Duplicate") <> 0) Then
...
ElseIf ErrNumber = -2147217833 OR InStrB(ErrDescr, "Daten zu lang") <> 0 OR InStrB(ErrDescr, "Data too long") <> 0 THEN
 ...
 for k = iif(SammelInsert<>0,1,i) to iif(SammelInsert<>0,ubound(rLw),i)
  ...
  IF Len(rLw(k).Langtext) > maxi(1) THEN maxi(1) = Len(rLw(k).Langtext)
  IF Len(rLw(k).KuQu) > maxi(2) THEN maxi(2) = Len(rLw(k).KuQu)
  IF Len(rLw(k).Quelle) > maxi(3) THEN maxi(3) = Len(rLw(k).Quelle)
  ...
  IF Len(rLw(k).Teststatus) > maxi(7) THEN maxi(7) = Len(rLw(k).Teststatus)
  IF Len(rLw(k).abrd) > maxi(8) THEN maxi(8) = Len(rLw(k).abrd)
  IF Len(rLw(k).Hinweise) > maxi(9) THEN maxi(9) = Len(rLw(k).Hinweise)
  IF Len(rLw(k).fICD) > maxi(10) THEN maxi(10) = Len(rLw(k).fICD)
  IF Len(rLw(k).Vorwert_1) > maxi(11) THEN maxi(11) = Len(rLw(k).Vorwert_1)
  IF Len(rLw(k).Vorwert_2) > maxi(12) THEN maxi(12) = Len(rLw(k).Vorwert_2)
 next k
 nochmal:
 SET rsc = New ADODB.Recordset
 SET rsc = DBCnOSchema(adSchemaColumns, Array(Empty, Empty, LCase$(tbnm), Empty))
    ...
    IF maxL > 0 THEN
     For k = IIf(SammelInsert <> 0,1, i) To IIf(SammelInsert <> 0,ubound(rLw), i)
      SELECT CASE m
       ...
       Case 1: Lese.Ausgeb "   Verkürze Inhalt von rLw.Langtext: '" & rLw(k).Langtext & "' -> '" & Left$(rLw(k).Langtext, maxL)  & "'",true : rLw(k).Langtext = Left$(rLw(k).Langtext, maxL)
       Case 2: Lese.Ausgeb "   Verkürze Inhalt von rLw.KuQu: '" & rLw(k).KuQu & "' -> '" & Left$(rLw(k).KuQu, maxL)  & "'",true : rLw(k).KuQu = Left$(rLw(k).KuQu, maxL)
       ...
       Case 7: Lese.Ausgeb "   Verkürze Inhalt von rLw.Teststatus: '" & rLw(k).Teststatus & "' -> '" & Left$(rLw(k).Teststatus, maxL)  & "'",true : rLw(k).Teststatus = Left$(rLw(k).Teststatus, maxL)
       Case 8: Lese.Ausgeb "   Verkürze Inhalt von rLw.abrd: '" & rLw(k).abrd & "' -> '" & Left$(rLw(k).abrd, maxL)  & "'",true : rLw(k).abrd = Left$(rLw(k).abrd, maxL)
       Case 9: Lese.Ausgeb "   Verkürze Inhalt von rLw.Hinweise: '" & rLw(k).Hinweise & "' -> '" & Left$(rLw(k).Hinweise, maxL)  & "'",true : rLw(k).Hinweise = Left$(rLw(k).Hinweise, maxL)
       Case 10: Lese.Ausgeb "   Verkürze Inhalt von rLw.fICD: '" & rLw(k).fICD & "' -> '" & Left$(rLw(k).fICD, maxL)  & "'",true : rLw(k).fICD = Left$(rLw(k).fICD, maxL)
       Case 11: Lese.Ausgeb "   Verkürze Inhalt von rLw.Vorwert_1: '" & rLw(k).Vorwert_1 & "' -> '" & Left$(rLw(k).Vorwert_1, maxL)  & "'",true : rLw(k).Vorwert_1 = Left$(rLw(k).Vorwert_1, maxL)
       Case 12: Lese.Ausgeb "   Verkürze Inhalt von rLw.Vorwert_2: '" & rLw(k).Vorwert_2 & "' -> '" & Left$(rLw(k).Vorwert_2, maxL)  & "'",true : rLw(k).Vorwert_2 = Left$(rLw(k).Vorwert_2, maxL)
      END SELECT
     Next
    elseif maxl < 0 THEN
     goto nochmal
...
#Else
 AnwPfad = App.Path
#END IF
 SELECT CASE MsgBox("FNr: " + CStr(ErrNumber) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in laborywertSpeichern/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume sql: If ErrNumber = 998 Then Resume sql Else Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
End FUNCTION ' laborywertSpeichern
...
Public FUNCTION rLLDump()
 ...
 For i = 1 To UBound(rLL)
  Print #200, vbCrLf & "i: " & i
  Print #200, Left$("rLL(" & i & ").ID:" & String$(33, "."), 33) & rLL(i).ID
  Print #200, Left$("rLL(" & i & ").UsID:" & String$(33, "."), 33) & rLL(i).UsID
 ...
 Close #200
 zeigan ffadat
End Function ' laboryleistDump

Public Function laboryleistSpeichern(SammelInsert%, BezfSp%, Optional rAf&, Optional sfkco%, Optional tbnm="laboryleist")
 Dim i&, rAFi&, Pid$, m%, sfnr%, altmode$, ErrD$, ErrN& ',sql0$
 Dim csql0 As New CString, csql As New CString
 Dim rs As New ADODB.recordset
 T1 = Timer
 ...
 Pid = rNa(0).Pat_id
 On Error GoTo fehler
 Call csql0.AppVar(Array(" INSERT ", sqlIgnore, "INTO `" & LCase$(tbnm) & "` (UsID,Abkü,Verf," & _
     "EBM,goä,Anzahl,abrd)   VALUES"))
sql:
 csql.m_Len = 0
 For i = 1 to ubound(rLL)
  If i Mod 10 = 0 Then syscmd 4, pid & ": Speichere Satz " & i & "/" & UBound(rLL) + 0 & " in `" & Tbnm & "`"
setz:
  IF SammelInsert = 0 Or i = 1 Then
   csql.Append csql0
  End If ' SammelInsert = 0 Or i = 1 Then
  csql.AppVar Array("(" , rLL(i).UsID, ",'" , rLL(i).Abkü, "','" , rLL(i).Verf, "','" , rLL(i).EBM, "','" , rLL(i).goä, "','" , rLL(i).Anzahl, "','" , rLL(i).abrd, "')")
  ...
  IF SammelInsert = 0 OR i = ubound(rLL) Then
    ...
    If ErrN Then
     If SammelInsert = 1 And ErrN = -2147217900 Then
      ...
      GoTo sql
     ElseIf InStrB(ErrD, "Duplicate") <> 0 Then
      rLL(i).ID = myEFrag("SELECT MAX(ID)+1 FROM `" & LCase$(tbnm) & "`", , DBCn).Fields(0)
      csql.m_Len = 0
      GoTo setz
     Else ' SammelInsert = 1 And ErrN = -2147217900 Then elseif
      Error ErrN
...
sfnr = sfnr + 1
If sfnr > 10 then 
 Lese.Ausgeb sfnr & " Fehler in ""laboryleistSpeichern()"" bei Pat. " & rNa(0).Pat_id & ", gebe auf (ErrDes: " & ErrDescr & ")", True
 sfnr = 0
 Resume Next
End if ' sfnr > 10
IF ErrNumber = -2147217900 AND (InStrB(ErrDescr, "Doppelter Eintrag") <> 0 Or InStrB(ErrDescr, "Duplicate") <> 0) Then
...
#Else
 AnwPfad = App.Path
#END IF
 SELECT CASE MsgBox("FNr: " + CStr(ErrNumber) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in laboryleistSpeichern/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume sql: If ErrNumber = 998 Then Resume sql Else Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
End FUNCTION ' laboryleistSpeichern
...
sql:
 csql.m_Len = 0
 For i = 1 to ubound(rLi)
  If i Mod 10 = 0 Then syscmd 4, pid & ": Speichere Satz " & i & "/" & UBound(rLi) + 0 & " in `" & Tbnm & "`"
setz:
  IF SammelInsert = 0 Or i = 1 Then
   csql.Append csql0
  End If ' SammelInsert = 0 Or i = 1 Then
...
#Else
 AnwPfad = App.Path
#END IF
 SELECT CASE MsgBox("FNr: " + CStr(ErrNumber) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " & cstr(nz(err.source,"")) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in liuezSpeichern/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume sql: If ErrNumber = 998 Then Resume sql Else Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
#END IF
 ...
 IF InStrB(ErrDescr, "'READ-COMMITTED'") <> 0 THEN
  ...
  Resume
 END IF
 SELECT CASE MsgBox("FNr: " & CStr(Err.Number) & vbCrLf & "LastDLLError: " & CStr(Err.LastDllError) & vbCrLf & "Source: " & cstr(nz(err.source,"")) & vbCrLf & "Description: " & Err.Description, vbAbortRetryIgnore, "aufgefangener Fehler in tuSpeichern/" + AnwPfad)
  Case vbAbort: Call MsgBox(" Höre auf "): Progende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
 END SELECT
...
Public Function tuStutzen() 
 ...
 Call myEFrag("DELETE FROM `laboryus` WHERE pat_id>100000", rAf, DBCn, , ErrNr, ErrD)
