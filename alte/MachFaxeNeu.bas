...
'Bauanleitung für eine Datenbank wie `//linux1/faxeinp` vom 10.7.11 21:42:22
Option Explicit
...
Dim Str(1, 9, 34) As New CString, ArtZ&(3, 9)
...
Sub FüllStr1()
 ...
 Str(1, 1, 22) = " ENGINE=InnoDB AUTO_INCREMENT=23801 DEFAULT CHARSET=latin1 COLLATE=latin1_german2_ci"
End Sub ' FüllStr1
...
Sub FüllStr2()
 ...
 Str(1, 2, 1) = " `titel` varchar(825) COLLATE latin1_german2_ci DEFAULT NULL"
...
Sub FüllStr3()
 ...
 Str(1, 3, 1) = " `titel` varchar(825) COLLATE latin1_german2_ci DEFAULT NULL"
...
Sub FüllStr4()
 ...
 Str(1, 4, 1) = " `titel` varchar(596) COLLATE latin1_german2_ci DEFAULT NULL"
 ...
 Str(1, 4, 15) = " `rcname` varchar(596) COLLATE latin1_german2_ci DEFAULT NULL"
 ...
 Str(1, 4, 20) = " `Pat_id` int(10) unsigned DEFAULT NULL"
 Str(1, 4, 21) = "  KEY `Id` (`id`)"
 Str(1, 4, 22) = "  KEY `submt` (`submt`)"
 Str(1, 4, 23) = "  KEY `oscht` (`oscht`)"
 Str(1, 4, 24) = "  KEY `docname` (`docname`)"
 Str(1, 4, 25) = "  KEY `Pat_id` (`Pat_id`)"
 Str(1, 4, 26) = " ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_german2_ci ROW_FORMAT=DYNAMIC"
End Sub ' FüllStr4
...
Sub FüllStr5()
 ...
 Str(1, 5, 1) = " `titel` varchar(568) COLLATE latin1_german2_ci DEFAULT NULL"
 ...
 Str(1, 5, 21) = " `rcname` varchar(568) COLLATE latin1_german2_ci DEFAULT NULL"
 ...
 Str(1, 5, 27) = " `Pat_id` int(10) unsigned DEFAULT NULL"
 Str(1, 5, 28) = "  KEY `Id` (`id`)"
 Str(1, 5, 29) = "  KEY `submt` (`submt`)"
 Str(1, 5, 30) = "  KEY `scht` (`scht`)"
 Str(1, 5, 31) = "  KEY `docname` (`docname`)"
 Str(1, 5, 32) = "  KEY `pat_id` (`Pat_id`)"
 Str(1, 5, 33) = " ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_german2_ci ROW_FORMAT=FIXED"
End Sub ' FüllStr5
...
Sub FüllStr8()
 ...
 Str(1, 8, 5) = " ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=latin1 COLLATE=latin1_german2_ci"
End Sub ' FüllStr8
...
Sub FüllStr9()
 ...
 Str(1, 9, 11) = " ENGINE=InnoDB AUTO_INCREMENT=47447 DEFAULT CHARSET=latin1 COLLATE=latin1_german2_ci"
End Sub ' FüllStr9
...
#Else
 AnwPfad = App.Path
#End If
Select Case MsgBox("FNr: " & FNr & ", ErrNr: " & CStr(Err.Number) & vbCrLf & "LastDLLError: " & CStr(Err.LastDllError) & vbCrLf & "Source: " & IIf(IsNull(Err.source), "", CStr(Err.source)) & vbCrLf & "Description: " & Err.Description, vbAbortRetryIgnore, "Aufgefangener Fehler in doMach_faxeinp/" & AnwPfad)
 Case vbAbort: Call MsgBox(" Höre auf "): ProgEnde
 Case vbRetry: Call MsgBox(" Versuche nochmal "): Resume
 Case vbIgnore: Call MsgBox(" Setze fort "): Resume Next
End Select
