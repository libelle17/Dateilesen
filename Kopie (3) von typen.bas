...
Public type namen
 ...
 obhierdmp As integer 'obhierdmp 11 'Ergebnis der obhierdmp-Funktion
 obdmp As integer 'obdmp 11 'Ergebnis der obdmp-Variablen in der obhierdmp-Funktion
 getHA0 As long 'getHA0 3 'KVNr aus getHausarzt -> Üw(12,0)
 getHA1 As long 'getHA1 3 '
 getHA2 As long 'getHA2 3 '
...
Public type anamnesebogen
 ...
 tabakex As string 'tabakex 129 '
 tabakbis As string 'tabakbis 129 '
 tabakakt As string 'tabakakt 129 '
 tabakmenge As string 'tabakmenge 129 '
...
' sql0 = " insert " & sqlignore &  "into `namen` (Pat_ID,lfdnr,NVorsatz," & _
     ...
     "StByte,Cave,Notiz,obhierdmp,obdmp,getHA0,getHA1,getHA2,zubenach,Verwandt," & _
     "Sprache,lAktTM) values
...
'  rNa(i).AktZeit = now()
  ...
  csql.AppVar Array("(" , rNa(i).Pat_ID , "," , rNa(i).lfdnr , ",'" , rNa(i).NVorsatz , "','" , rNa(i).Nachname , "','" , rNa(i).Vorname , "'," , datform( _
   ...
   rNa(i).An1da)) , "," , cstr(cint(rNa(i).An2da)) , "," , cstr(cint(rNa(i).Checkda)) , ",'" , rNa(i).DMTypaD , "'," , datform( _
    0 ) , "," , rNa(i).absPos , "," , rNa(i).StByte , ",'" , rNa(i).Cave , "','" , rNa(i).Notiz , "'," , cstr(cint(rNa(i).obhierdmp)) , "," , cstr(cint( _
   rNa(i).obdmp)) , "," , rNa(i).getHA0 , "," , rNa(i).getHA1 , "," , rNa(i).getHA2 , ",'" , rNa(i).zubenach , "','" , rNa(i).Verwandt , "','" ,  _
...
' sql0 = " insert " & sqlignore &  "into `faelle` (Pat_ID,Quartal,Nachname," & _
     ...
     "f4206,ÜwText,f4210,AkfHAH,AkfAB0,AkfAK,statNuller,ÜbwV,AndÜw,Übw," & _
     "ÜbwLANR,ÜWZiel,ÜWNNr,ÜWNaN,ÜWTit,ÜWVor,ÜWVsw,üwvid,statKlasse,f4237," & _
     "statBehTage,SchGr,Weiterbeh,PGeb,PGebErg,Mahnfrist,GOÄKatNr,GOÄKatName,abrArzt,privVers," & _
...
'  rFa(i).AktZeit = now()
  ...
  csql.AppVar Array("(" , rFa(i).Pat_ID , ",'" , rFa(i).Quartal , "','" , rFa(i).Nachname , "','" , rFa(i).Vorname , "'," , rFa(i).lfdnr , ",'" , rFa(i).TMFNr , "','" ,  _
   ...
   rFa(i).KVKserg , "','" , rFa(i).Kasse , "','" , rFa(i).GebOr , "','" , rFa(i).AbrGb , "','" , rFa(i).PersKreis , "','" , rFa(i).SKtZusatz , "','" ,  _
   rFa(i).f4206 , "','" , rFa(i).ÜwText , "'," , rFa(i).f4210 , "," , rFa(i).AkfHAH , "," , rFa(i).AkfAB0 , "," , rFa(i).AkfAK , ",'" ,  _
   rFa(i).statNuller , "','" , rFa(i).ÜbwV , "','" , rFa(i).AndÜw , "','" , rFa(i).Übw , "','" , rFa(i).ÜbwLANR , "','" , rFa(i).ÜWZiel , "','" ,  _
   rFa(i).ÜWNNr , "','" , rFa(i).ÜWNaN , "','" , rFa(i).ÜWTit , "','" , rFa(i).ÜWVor , "','" , rFa(i).ÜWVsw , "'," , rFa(i).üwvid , ",'" ,  _
   rFa(i).statKlasse , "','" , rFa(i).f4237 , "'," , rFa(i).statBehTage , "," , rFa(i).SchGr , ",'" , rFa(i).Weiterbeh , "','" , rFa(i).PGeb , "','" ,  _
   rFa(i).PGebErg , "','" , rFa(i).Mahnfrist , "','" , rFa(i).GOÄKatNr , "','" , rFa(i).GOÄKatName , "','" , rFa(i).abrArzt , "','" , rFa(i).privVers , "','" ,  _
   rFa(i).AdNam , "','" , rFa(i).AdStr , "','" , rFa(i).AdPlz , "','" , rFa(i).AdOrt , "'," , datform(rFa(i).BhFE) , ",'" ,  _
   rFa(i).s8000 , "','" , rFa(i).s8100 , "'," , datform(rFa(i).AktZeit) , "," , datform(rFa(i).Fanf) , ",'" , rFa(i).altQuart , "'," , datform(rFa(i).QAnf) , "," , datform( _
...
ElseIf Err.Number = -2147217833 Then
 ...
 for k = iif(Lese.dlg.SammelInsert<>0,1,i) to iif(Lese.dlg.SammelInsert<>0,ubound(rFa),i)
  ...
  If Len(rFa(k).AndÜw) > maxi(20) Then maxi(20) = Len(rFa(k).AndÜw)
  If Len(rFa(k).Übw) > maxi(21) Then maxi(21) = Len(rFa(k).Übw)
  If Len(rFa(k).ÜbwLANR) > maxi(22) Then maxi(22) = Len(rFa(k).ÜbwLANR)
  If Len(rFa(k).ÜWZiel) > maxi(23) Then maxi(23) = Len(rFa(k).ÜWZiel)
  If Len(rFa(k).ÜWNNr) > maxi(24) Then maxi(24) = Len(rFa(k).ÜWNNr)
  If Len(rFa(k).ÜWNaN) > maxi(25) Then maxi(25) = Len(rFa(k).ÜWNaN)
  If Len(rFa(k).ÜWTit) > maxi(26) Then maxi(26) = Len(rFa(k).ÜWTit)
  If Len(rFa(k).ÜWVor) > maxi(27) Then maxi(27) = Len(rFa(k).ÜWVor)
  If Len(rFa(k).ÜWVsw) > maxi(28) Then maxi(28) = Len(rFa(k).ÜWVsw)
  If Len(rFa(k).statKlasse) > maxi(29) Then maxi(29) = Len(rFa(k).statKlasse)
  If Len(rFa(k).f4237) > maxi(30) Then maxi(30) = Len(rFa(k).f4237)
  If Len(rFa(k).Weiterbeh) > maxi(31) Then maxi(31) = Len(rFa(k).Weiterbeh)
  If Len(rFa(k).PGeb) > maxi(32) Then maxi(32) = Len(rFa(k).PGeb)
  If Len(rFa(k).PGebErg) > maxi(33) Then maxi(33) = Len(rFa(k).PGebErg)
  If Len(rFa(k).Mahnfrist) > maxi(34) Then maxi(34) = Len(rFa(k).Mahnfrist)
  If Len(rFa(k).GOÄKatNr) > maxi(35) Then maxi(35) = Len(rFa(k).GOÄKatNr)
  If Len(rFa(k).GOÄKatName) > maxi(36) Then maxi(36) = Len(rFa(k).GOÄKatName)
  If Len(rFa(k).abrArzt) > maxi(37) Then maxi(37) = Len(rFa(k).abrArzt)
  If Len(rFa(k).privVers) > maxi(38) Then maxi(38) = Len(rFa(k).privVers)
  If Len(rFa(k).AdNam) > maxi(39) Then maxi(39) = Len(rFa(k).AdNam)
  If Len(rFa(k).AdStr) > maxi(40) Then maxi(40) = Len(rFa(k).AdStr)
  If Len(rFa(k).AdPlz) > maxi(41) Then maxi(41) = Len(rFa(k).AdPlz)
  If Len(rFa(k).AdOrt) > maxi(42) Then maxi(42) = Len(rFa(k).AdOrt)
  If Len(rFa(k).s8000) > maxi(43) Then maxi(43) = Len(rFa(k).s8000)
  If Len(rFa(k).s8100) > maxi(44) Then maxi(44) = Len(rFa(k).s8100)
  If Len(rFa(k).altQuart) > maxi(45) Then maxi(45) = Len(rFa(k).altQuart)
  If Len(rFa(k).QS) > maxi(46) Then maxi(46) = Len(rFa(k).QS)
  If Len(rFa(k).QT) > maxi(47) Then maxi(47) = Len(rFa(k).QT)
 next k
 DBCn.CommitTrans
 nochmal:
 Set rsc = New ADODB.Recordset
    ...
    If maxL > 0 Then
     For k = IIf(Lese.dlg.SammelInsert <> 0,1, i) To IIf(Lese.dlg.SammelInsert <> 0,ubound(rFa), i)
      Select Case m
       ...
       Case 12: Lese.Ausgeb "   Verkürze Inhalt von rFa.Kasse: '" & rFa(k).Kasse & "' -> '" & Left$(rFa(k).Kasse, maxL)  & "'",true : rFa(k).Kasse = Left$(rFa(k).Kasse, maxL)
       Case 13: Lese.Ausgeb "   Verkürze Inhalt von rFa.GebOr: '" & rFa(k).GebOr & "' -> '" & Left$(rFa(k).GebOr, maxL)  & "'",true : rFa(k).GebOr = Left$(rFa(k).GebOr, maxL)
       Case 14: Lese.Ausgeb "   Verkürze Inhalt von rFa.AbrGb: '" & rFa(k).AbrGb & "' -> '" & Left$(rFa(k).AbrGb, maxL)  & "'",true : rFa(k).AbrGb = Left$(rFa(k).AbrGb, maxL)
       Case 15: Lese.Ausgeb "   Verkürze Inhalt von rFa.PersKreis: '" & rFa(k).PersKreis & "' -> '" & Left$(rFa(k).PersKreis, maxL)  & "'",true : rFa(k).PersKreis = Left$(rFa(k).PersKreis, maxL)
       Case 16: Lese.Ausgeb "   Verkürze Inhalt von rFa.SKtZusatz: '" & rFa(k).SKtZusatz & "' -> '" & Left$(rFa(k).SKtZusatz, maxL)  & "'",true : rFa(k).SKtZusatz = Left$(rFa(k).SKtZusatz, maxL)
       Case 17: Lese.Ausgeb "   Verkürze Inhalt von rFa.f4206: '" & rFa(k).f4206 & "' -> '" & Left$(rFa(k).f4206, maxL)  & "'",true : rFa(k).f4206 = Left$(rFa(k).f4206, maxL)
       Case 18: Lese.Ausgeb "   Verkürze Inhalt von rFa.ÜwText: '" & rFa(k).ÜwText & "' -> '" & Left$(rFa(k).ÜwText, maxL)  & "'",true : rFa(k).ÜwText = Left$(rFa(k).ÜwText, maxL)
       Case 19: Lese.Ausgeb "   Verkürze Inhalt von rFa.statNuller: '" & rFa(k).statNuller & "' -> '" & Left$(rFa(k).statNuller, maxL)  & "'",true : rFa(k).statNuller = Left$(rFa(k).statNuller, maxL)
       Case 20: Lese.Ausgeb "   Verkürze Inhalt von rFa.ÜbwV: '" & rFa(k).ÜbwV & "' -> '" & Left$(rFa(k).ÜbwV, maxL)  & "'",true : rFa(k).ÜbwV = Left$(rFa(k).ÜbwV, maxL)
       Case 21: Lese.Ausgeb "   Verkürze Inhalt von rFa.AndÜw: '" & rFa(k).AndÜw & "' -> '" & Left$(rFa(k).AndÜw, maxL)  & "'",true : rFa(k).AndÜw = Left$(rFa(k).AndÜw, maxL)
       Case 22: Lese.Ausgeb "   Verkürze Inhalt von rFa.Übw: '" & rFa(k).Übw & "' -> '" & Left$(rFa(k).Übw, maxL)  & "'",true : rFa(k).Übw = Left$(rFa(k).Übw, maxL)
       Case 23: Lese.Ausgeb "   Verkürze Inhalt von rFa.ÜbwLANR: '" & rFa(k).ÜbwLANR & "' -> '" & Left$(rFa(k).ÜbwLANR, maxL)  & "'",true : rFa(k).ÜbwLANR = Left$(rFa(k).ÜbwLANR, maxL)
       Case 24: Lese.Ausgeb "   Verkürze Inhalt von rFa.ÜWZiel: '" & rFa(k).ÜWZiel & "' -> '" & Left$(rFa(k).ÜWZiel, maxL)  & "'",true : rFa(k).ÜWZiel = Left$(rFa(k).ÜWZiel, maxL)
       Case 25: Lese.Ausgeb "   Verkürze Inhalt von rFa.ÜWNNr: '" & rFa(k).ÜWNNr & "' -> '" & Left$(rFa(k).ÜWNNr, maxL)  & "'",true : rFa(k).ÜWNNr = Left$(rFa(k).ÜWNNr, maxL)
       Case 26: Lese.Ausgeb "   Verkürze Inhalt von rFa.ÜWNaN: '" & rFa(k).ÜWNaN & "' -> '" & Left$(rFa(k).ÜWNaN, maxL)  & "'",true : rFa(k).ÜWNaN = Left$(rFa(k).ÜWNaN, maxL)
       Case 27: Lese.Ausgeb "   Verkürze Inhalt von rFa.ÜWTit: '" & rFa(k).ÜWTit & "' -> '" & Left$(rFa(k).ÜWTit, maxL)  & "'",true : rFa(k).ÜWTit = Left$(rFa(k).ÜWTit, maxL)
       Case 28: Lese.Ausgeb "   Verkürze Inhalt von rFa.ÜWVor: '" & rFa(k).ÜWVor & "' -> '" & Left$(rFa(k).ÜWVor, maxL)  & "'",true : rFa(k).ÜWVor = Left$(rFa(k).ÜWVor, maxL)
       Case 29: Lese.Ausgeb "   Verkürze Inhalt von rFa.ÜWVsw: '" & rFa(k).ÜWVsw & "' -> '" & Left$(rFa(k).ÜWVsw, maxL)  & "'",true : rFa(k).ÜWVsw = Left$(rFa(k).ÜWVsw, maxL)
       Case 30: Lese.Ausgeb "   Verkürze Inhalt von rFa.statKlasse: '" & rFa(k).statKlasse & "' -> '" & Left$(rFa(k).statKlasse, maxL)  & "'",true : rFa(k).statKlasse = Left$(rFa(k).statKlasse, maxL)
       Case 31: Lese.Ausgeb "   Verkürze Inhalt von rFa.f4237: '" & rFa(k).f4237 & "' -> '" & Left$(rFa(k).f4237, maxL)  & "'",true : rFa(k).f4237 = Left$(rFa(k).f4237, maxL)
       Case 32: Lese.Ausgeb "   Verkürze Inhalt von rFa.Weiterbeh: '" & rFa(k).Weiterbeh & "' -> '" & Left$(rFa(k).Weiterbeh, maxL)  & "'",true : rFa(k).Weiterbeh = Left$(rFa(k).Weiterbeh, maxL)
       Case 33: Lese.Ausgeb "   Verkürze Inhalt von rFa.PGeb: '" & rFa(k).PGeb & "' -> '" & Left$(rFa(k).PGeb, maxL)  & "'",true : rFa(k).PGeb = Left$(rFa(k).PGeb, maxL)
       Case 34: Lese.Ausgeb "   Verkürze Inhalt von rFa.PGebErg: '" & rFa(k).PGebErg & "' -> '" & Left$(rFa(k).PGebErg, maxL)  & "'",true : rFa(k).PGebErg = Left$(rFa(k).PGebErg, maxL)
       Case 35: Lese.Ausgeb "   Verkürze Inhalt von rFa.Mahnfrist: '" & rFa(k).Mahnfrist & "' -> '" & Left$(rFa(k).Mahnfrist, maxL)  & "'",true : rFa(k).Mahnfrist = Left$(rFa(k).Mahnfrist, maxL)
       Case 36: Lese.Ausgeb "   Verkürze Inhalt von rFa.GOÄKatNr: '" & rFa(k).GOÄKatNr & "' -> '" & Left$(rFa(k).GOÄKatNr, maxL)  & "'",true : rFa(k).GOÄKatNr = Left$(rFa(k).GOÄKatNr, maxL)
       Case 37: Lese.Ausgeb "   Verkürze Inhalt von rFa.GOÄKatName: '" & rFa(k).GOÄKatName & "' -> '" & Left$(rFa(k).GOÄKatName, maxL)  & "'",true : rFa(k).GOÄKatName = Left$(rFa(k).GOÄKatName, maxL)
       Case 38: Lese.Ausgeb "   Verkürze Inhalt von rFa.abrArzt: '" & rFa(k).abrArzt & "' -> '" & Left$(rFa(k).abrArzt, maxL)  & "'",true : rFa(k).abrArzt = Left$(rFa(k).abrArzt, maxL)
       Case 39: Lese.Ausgeb "   Verkürze Inhalt von rFa.privVers: '" & rFa(k).privVers & "' -> '" & Left$(rFa(k).privVers, maxL)  & "'",true : rFa(k).privVers = Left$(rFa(k).privVers, maxL)
       Case 40: Lese.Ausgeb "   Verkürze Inhalt von rFa.AdNam: '" & rFa(k).AdNam & "' -> '" & Left$(rFa(k).AdNam, maxL)  & "'",true : rFa(k).AdNam = Left$(rFa(k).AdNam, maxL)
       Case 41: Lese.Ausgeb "   Verkürze Inhalt von rFa.AdStr: '" & rFa(k).AdStr & "' -> '" & Left$(rFa(k).AdStr, maxL)  & "'",true : rFa(k).AdStr = Left$(rFa(k).AdStr, maxL)
       Case 42: Lese.Ausgeb "   Verkürze Inhalt von rFa.AdPlz: '" & rFa(k).AdPlz & "' -> '" & Left$(rFa(k).AdPlz, maxL)  & "'",true : rFa(k).AdPlz = Left$(rFa(k).AdPlz, maxL)
       Case 43: Lese.Ausgeb "   Verkürze Inhalt von rFa.AdOrt: '" & rFa(k).AdOrt & "' -> '" & Left$(rFa(k).AdOrt, maxL)  & "'",true : rFa(k).AdOrt = Left$(rFa(k).AdOrt, maxL)
       Case 44: Lese.Ausgeb "   Verkürze Inhalt von rFa.s8000: '" & rFa(k).s8000 & "' -> '" & Left$(rFa(k).s8000, maxL)  & "'",true : rFa(k).s8000 = Left$(rFa(k).s8000, maxL)
       Case 45: Lese.Ausgeb "   Verkürze Inhalt von rFa.s8100: '" & rFa(k).s8100 & "' -> '" & Left$(rFa(k).s8100, maxL)  & "'",true : rFa(k).s8100 = Left$(rFa(k).s8100, maxL)
       Case 46: Lese.Ausgeb "   Verkürze Inhalt von rFa.altQuart: '" & rFa(k).altQuart & "' -> '" & Left$(rFa(k).altQuart, maxL)  & "'",true : rFa(k).altQuart = Left$(rFa(k).altQuart, maxL)
       Case 47: Lese.Ausgeb "   Verkürze Inhalt von rFa.QS: '" & rFa(k).QS & "' -> '" & Left$(rFa(k).QS, maxL)  & "'",true : rFa(k).QS = Left$(rFa(k).QS, maxL)
       Case 48: Lese.Ausgeb "   Verkürze Inhalt von rFa.QT: '" & rFa(k).QT & "' -> '" & Left$(rFa(k).QT, maxL)  & "'",true : rFa(k).QT = Left$(rFa(k).QT, maxL)
      End Select
     Next
    elseif maxl < 0 then
     goto nochmal
...
'  rBr(i).AktZeit = now()
  ...
  csql.AppVar Array("(" , rBr(i).FID , "," , rBr(i).Pat_ID , "," , datform(rBr(i).ZeitPunkt) , ",'" , rBr(i).Pfad , "','" , rBr(i).Art , "','" , rBr(i).Name , "','" ,  _
   rBr(i).Typ , "'," , datform(rBr(i).AktZeit) , "," , rBr(i).DokGroe , "," , datform(rBr(i).DokAenD) , ",'" , rBr(i).QS , "','" ,  _
...
'  rDo(i).AktZeit = now()
  ...
  csql.AppVar Array("(" , rDo(i).FID , "," , rDo(i).Pat_ID , "," , datform(rDo(i).ZeitPunkt) , ",'" , rDo(i).DokPfad , "','" , rDo(i).DokArt , "','" ,  _
   rDo(i).DokName , "'," , datform(rDo(i).Quelldatum) , "," , rDo(i).absPos , "," , datform(rDo(i).AktZeit) , "," , rDo(i).DokGroe , "," , datform( _
...
'  rDm(i).AktZeit = now()
  ...
  csql.AppVar Array("('" , rDm(i).Abk , "','" , rDm(i).Art , "'," , datform(rDm(i).KarteiDatum) , "," , datform(rDm(i).exportiert) , "," , datform(rDm(i).DokuDatum) , "," , cstr(cint( _
   rDm(i).obvoll)) , "," , cstr(cint(rDm(i).ok)) , "," , cstr(cint(rDm(i).ausgedruckt)) , ",'" , rDm(i).NachName , "','" ,  _
   rDm(i).VorName , "'," , datform(rDm(i).GebDat) , "," , rDm(i).Pat_id , "," , rDm(i).StByte , "," , datform(rDm(i).AktZeit) , ")")
...
'  rLu(i).AktZeit = now()
  ...
  csql.AppVar Array("(" , rLu(i).DatID , "," , rLu(i).SatzID , ",'" , rLu(i).Satzart , "','" , rLu(i).Satzlänge , "','" , rLu(i).Auftragsnummer , "','" ,  _
   ...
   rLu(i).Pat_idErwGL , "','" , rLu(i).Pat_idLaborNeu , "'," , datform(rLu(i).ZeitpunktLaborneu) , "," , rLu(i).ZdüP , "," ,  _
   rLu(i).ZdiP , ",'" , rLu(i).LWerte , "'," , datform(rLu(i).verglichen) , "," , rLu(i).AfN , ")")
    ...
    If maxL > 0 Then
     For k = IIf(Lese.dlg.SammelInsert <> 0,j, i) To IIf(Lese.dlg.SammelInsert <> 0,j, i)
      Select Case m
       ...
       Case 14: Lese.Ausgeb "   Verkürze Inhalt von rLu.Auftraggeber: '" & rLu(k).Auftraggeber & "' -> '" & Left$(rLu(k).Auftraggeber, maxL)  & "'",true : rLu(k).Auftraggeber = Left$(rLu(k).Auftraggeber, maxL)
       Case 15: Lese.Ausgeb "   Verkürze Inhalt von rLu.Patienteninformation: '" & rLu(k).Patienteninformation & "' -> '" & Left$(rLu(k).Patienteninformation, maxL)  & "'",true : rLu(k).Patienteninformation = Left$(rLu(k).Patienteninformation, maxL)
       Case 16: Lese.Ausgeb "   Verkürze Inhalt von rLu.Geschlecht: '" & rLu(k).Geschlecht & "' -> '" & Left$(rLu(k).Geschlecht, maxL)  & "'",true : rLu(k).Geschlecht = Left$(rLu(k).Geschlecht, maxL)
       Case 17: Lese.Ausgeb "   Verkürze Inhalt von rLu.AuftrHinw: '" & rLu(k).AuftrHinw & "' -> '" & Left$(rLu(k).AuftrHinw, maxL)  & "'",true : rLu(k).AuftrHinw = Left$(rLu(k).AuftrHinw, maxL)
       Case 18: Lese.Ausgeb "   Verkürze Inhalt von rLu.Pat_idUrsp: '" & rLu(k).Pat_idUrsp & "' -> '" & Left$(rLu(k).Pat_idUrsp, maxL)  & "'",true : rLu(k).Pat_idUrsp = Left$(rLu(k).Pat_idUrsp, maxL)
       Case 19: Lese.Ausgeb "   Verkürze Inhalt von rLu.Pat_idErwVNG: '" & rLu(k).Pat_idErwVNG & "' -> '" & Left$(rLu(k).Pat_idErwVNG, maxL)  & "'",true : rLu(k).Pat_idErwVNG = Left$(rLu(k).Pat_idErwVNG, maxL)
       Case 20: Lese.Ausgeb "   Verkürze Inhalt von rLu.Pat_idErwVN: '" & rLu(k).Pat_idErwVN & "' -> '" & Left$(rLu(k).Pat_idErwVN, maxL)  & "'",true : rLu(k).Pat_idErwVN = Left$(rLu(k).Pat_idErwVN, maxL)
       Case 21: Lese.Ausgeb "   Verkürze Inhalt von rLu.Pat_idErwG: '" & rLu(k).Pat_idErwG & "' -> '" & Left$(rLu(k).Pat_idErwG, maxL)  & "'",true : rLu(k).Pat_idErwG = Left$(rLu(k).Pat_idErwG, maxL)
       Case 22: Lese.Ausgeb "   Verkürze Inhalt von rLu.Pat_idErwGB: '" & rLu(k).Pat_idErwGB & "' -> '" & Left$(rLu(k).Pat_idErwGB, maxL)  & "'",true : rLu(k).Pat_idErwGB = Left$(rLu(k).Pat_idErwGB, maxL)
       Case 23: Lese.Ausgeb "   Verkürze Inhalt von rLu.Pat_idErwGL: '" & rLu(k).Pat_idErwGL & "' -> '" & Left$(rLu(k).Pat_idErwGL, maxL)  & "'",true : rLu(k).Pat_idErwGL = Left$(rLu(k).Pat_idErwGL, maxL)
       Case 24: Lese.Ausgeb "   Verkürze Inhalt von rLu.Pat_idLaborNeu: '" & rLu(k).Pat_idLaborNeu & "' -> '" & Left$(rLu(k).Pat_idLaborNeu, maxL)  & "'",true : rLu(k).Pat_idLaborNeu = Left$(rLu(k).Pat_idLaborNeu, maxL)
       Case 25: Lese.Ausgeb "   Verkürze Inhalt von rLu.LWerte: '" & rLu(k).LWerte & "' -> '" & Left$(rLu(k).LWerte, maxL)  & "'",true : rLu(k).LWerte = Left$(rLu(k).LWerte, maxL)
      End Select
     Next
    elseif maxl < 0 then
     goto nochmal
...
nextj:
   ...
   rLw(i).Quelle & "' and `QSpez` = '" & rLw(i).QSpez & "' and `AbnDat` = " & datform(rLw(i).AbnDat) & " and `Wert` = '" &  _
    ...
    If maxL > 0 Then
     For k = IIf(Lese.dlg.SammelInsert <> 0,1, i) To IIf(Lese.dlg.SammelInsert <> 0,ubound(rLw), i)
      Select Case m
       ...
       Case 11: Lese.Ausgeb "   Verkürze Inhalt von rLw.AuftrHinw: '" & rLw(k).AuftrHinw & "' -> '" & Left$(rLw(k).AuftrHinw, maxL)  & "'",true : rLw(k).AuftrHinw = Left$(rLw(k).AuftrHinw, maxL)
      End Select
     Next
    elseif maxl < 0 then
     goto nochmal
    ...
    If maxL > 0 Then
     For k = IIf(Lese.dlg.SammelInsert <> 0,1, i) To IIf(Lese.dlg.SammelInsert <> 0,ubound(rLL), i)
      Select Case m
       ...
       Case 6: Lese.Ausgeb "   Verkürze Inhalt von rLL.abrd: '" & rLL(k).abrd & "' -> '" & Left$(rLL(k).abrd, maxL)  & "'",true : rLL(k).abrd = Left$(rLL(k).abrd, maxL)
      End Select
     Next
    elseif maxl < 0 then
     goto nochmal
