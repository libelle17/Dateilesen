...
Public FUNCTION namenSpeichern(SammelInsert%, BezfSp%)
 ...
 Pid = rNa(0).Pat_id
 ON Error GoTo fehler
 syscmd 4, pid & ": Speichere " & ubound(rNa) & " Sätze in `namen`"
 IF NOT Allepat THEN
...
Public FUNCTION faelleSpeichern(SammelInsert%, BezfSp%)
 ...
 Pid = rNa(0).Pat_id
 ON Error GoTo fehler
 syscmd 4, pid & ": Speichere " & ubound(rFa) & " Sätze in `faelle`"
 IF NOT Allepat THEN
...
Public FUNCTION auSpeichern(SammelInsert%, BezfSp%)
 ...
 Pid = rNa(0).Pat_id
 ON Error GoTo fehler
 syscmd 4, pid & ": Speichere " & ubound(rAu) & " Sätze in `au`"
 IF NOT Allepat THEN
...
Public FUNCTION briefeSpeichern(SammelInsert%, BezfSp%)
 ...
 Pid = rNa(0).Pat_id
 ON Error GoTo fehler
 syscmd 4, pid & ": Speichere " & ubound(rBr) & " Sätze in `briefe`"
 IF NOT Allepat THEN
...
Public FUNCTION diagnosenSpeichern(SammelInsert%, BezfSp%)
 ...
 Pid = rNa(0).Pat_id
 ON Error GoTo fehler
 syscmd 4, pid & ": Speichere " & ubound(rDi) & " Sätze in `diagnosen`"
 IF NOT Allepat THEN
...
Public FUNCTION dokumenteSpeichern(SammelInsert%, BezfSp%)
 ...
 Pid = rNa(0).Pat_id
 ON Error GoTo fehler
 syscmd 4, pid & ": Speichere " & ubound(rDo) & " Sätze in `dokumente`"
 IF NOT Allepat THEN
...
Public FUNCTION eintraegeSpeichern(SammelInsert%, BezfSp%)
 ...
 Pid = rNa(0).Pat_id
 ON Error GoTo fehler
 syscmd 4, pid & ": Speichere " & ubound(rEi) & " Sätze in `eintraege`"
 IF NOT Allepat THEN
...
Public FUNCTION forminhaltform_abkSpeichern(SammelInsert%, BezfSp%)
 ...
 Pid = rNa(0).Pat_id
 ON Error GoTo fehler
 syscmd 4, pid & ": Speichere " & ubound(rFi) & " Sätze in `forminhaltform_abk`"
 IF NOT Allepat THEN
 END IF ' not allePat
...
Public FUNCTION formulareSpeichern(SammelInsert%, BezfSp%)
 ...
 Pid = rNa(0).Pat_id
 ON Error GoTo fehler
 syscmd 4, pid & ": Speichere " & ubound(rFo) & " Sätze in `formulare`"
 IF NOT Allepat THEN
 END IF ' not allePat
...
Public FUNCTION forminhkopfSpeichern(SammelInsert%, BezfSp%)
 ...
 Pid = rNa(0).Pat_id
 ON Error GoTo fehler
 syscmd 4, pid & ": Speichere " & ubound(rFr) & " Sätze in `forminhkopf`"
 IF NOT Allepat THEN
...
Public FUNCTION forminhfeldSpeichern(SammelInsert%, BezfSp%)
 ...
 Pid = rNa(0).Pat_id
 ON Error GoTo fehler
 syscmd 4, pid & ": Speichere " & ubound(rFm) & " Sätze in `forminhfeld`"
 IF NOT Allepat THEN
 END IF ' not allePat
...
Public FUNCTION kheinweisSpeichern(SammelInsert%, BezfSp%)
 ...
 Pid = rNa(0).Pat_id
 ON Error GoTo fehler
 syscmd 4, pid & ": Speichere " & ubound(rKh) & " Sätze in `kheinweis`"
 IF NOT Allepat THEN
...
Public FUNCTION lbanforderungenSpeichern(SammelInsert%, BezfSp%)
 ...
 Pid = rNa(0).Pat_id
 ON Error GoTo fehler
 syscmd 4, pid & ": Speichere " & ubound(rLb) & " Sätze in `lbanforderungen`"
 IF NOT Allepat THEN
...
Public FUNCTION laborneuSpeichern(SammelInsert%, BezfSp%)
 ...
 Pid = rNa(0).Pat_id
 ON Error GoTo fehler
 syscmd 4, pid & ": Speichere " & ubound(rLa) & " Sätze in `laborneu`"
 IF NOT Allepat THEN
...
Public FUNCTION leistungenSpeichern(SammelInsert%, BezfSp%)
 ...
 Pid = rNa(0).Pat_id
 ON Error GoTo fehler
 syscmd 4, pid & ": Speichere " & ubound(rLe) & " Sätze in `leistungen`"
 IF NOT Allepat THEN
...
Public FUNCTION medplanSpeichern(SammelInsert%, BezfSp%)
 ...
 Pid = rNa(0).Pat_id
 ON Error GoTo fehler
 syscmd 4, pid & ": Speichere " & ubound(rMe) & " Sätze in `medplan`"
 IF NOT Allepat THEN
...
Public FUNCTION rezepteintraegeSpeichern(SammelInsert%, BezfSp%)
 ...
 Pid = rNa(0).Pat_id
 ON Error GoTo fehler
 syscmd 4, pid & ": Speichere " & ubound(rRe) & " Sätze in `rezepteintraege`"
 IF NOT Allepat THEN
...
Public FUNCTION rrSpeichern(SammelInsert%, BezfSp%)
 ...
 Pid = rNa(0).Pat_id
 ON Error GoTo fehler
 syscmd 4, pid & ": Speichere " & ubound(rRr) & " Sätze in `rr`"
 IF NOT Allepat THEN
...
Public FUNCTION kvnrueSpeichern(SammelInsert%, BezfSp%)
 ...
 Pid = rNa(0).Pat_id
 ON Error GoTo fehler
 syscmd 4, pid & ": Speichere " & ubound(rKv) & " Sätze in `kvnrue`"
 IF NOT Allepat THEN
...
Public FUNCTION unbekannte_kennungenSpeichern(SammelInsert%, BezfSp%)
 ...
 On Error Resume Next
 Pid = rNa(0).Pat_id
 syscmd 4, pid & ": Speichere " & ubound(rUn) & " Sätze in `unbekannte_kennungen`"
 IF NOT Allepat THEN
 END IF ' not allePat
...
Public FUNCTION dmpreiheSpeichern(SammelInsert%, BezfSp%)
 ...
 Pid = rNa(0).Pat_id
 ON Error GoTo fehler
 syscmd 4, pid & ": Speichere " & ubound(rDm) & " Sätze in `dmpreihe`"
 IF NOT Allepat THEN
...
Public FUNCTION desktopSpeichern(SammelInsert%, BezfSp%)
 ...
 Pid = rNa(0).Pat_id
 ON Error GoTo fehler
 syscmd 4, pid & ": Speichere " & ubound(rDe) & " Sätze in `desktop`"
 IF NOT Allepat THEN
...
Public FUNCTION usdmSpeichern(SammelInsert%, BezfSp%)
 ...
 Pid = rNa(0).Pat_id
 ON Error GoTo fehler
 syscmd 4, pid & ": Speichere " & ubound(rUs) & " Sätze in `usdm`"
 IF NOT Allepat THEN
...
Public FUNCTION fussSpeichern(SammelInsert%, BezfSp%)
 ...
 Pid = rNa(0).Pat_id
 ON Error GoTo fehler
 syscmd 4, pid & ": Speichere " & ubound(rFu) & " Sätze in `fuss`"
 IF NOT Allepat THEN
...
Public FUNCTION ulcusSpeichern(SammelInsert%, BezfSp%)
 ...
 Pid = rNa(0).Pat_id
 ON Error GoTo fehler
 syscmd 4, pid & ": Speichere " & ubound(rUl) & " Sätze in `ulcus`"
 IF NOT Allepat THEN
...
Public FUNCTION vkgdSpeichern(SammelInsert%, BezfSp%)
 ...
 Pid = rNa(0).Pat_id
 ON Error GoTo fehler
 syscmd 4, pid & ": Speichere " & ubound(rVk) & " Sätze in `vkgd`"
 IF NOT Allepat THEN
...
Public FUNCTION swsSpeichern(SammelInsert%, BezfSp%)
 ...
 Pid = rNa(0).Pat_id
 ON Error GoTo fehler
 syscmd 4, pid & ": Speichere " & ubound(rSw) & " Sätze in `sws`"
 IF NOT Allepat THEN
...
Public FUNCTION laborxsaetzeSpeichern(SammelInsert%, BezfSp%)
 ...
 Pid = rNa(0).Pat_id
 ON Error GoTo fehler
 syscmd 4, pid & ": Speichere " & ubound(rLs) & " Sätze in `laborxsaetze`"
...
Public FUNCTION laborxeingelSpeichern(SammelInsert%, BezfSp%)
 ...
 Pid = rNa(0).Pat_id
 ON Error GoTo fehler
 syscmd 4, pid & ": Speichere " & ubound(rLg) & " Sätze in `laborxeingel`"
...
Public FUNCTION laborxusSpeichern(SammelInsert%, BezfSp%, j&)
 ...
 Pid = rNa(0).Pat_id
 ON Error GoTo fehler
 syscmd 4, pid & ": Speichere " & ubound(rLu) & " Sätze in `laborxus`"
...
Public FUNCTION laborxbaktSpeichern(SammelInsert%, BezfSp%)
 ...
 Pid = rNa(0).Pat_id
 ON Error GoTo fehler
 syscmd 4, pid & ": Speichere " & ubound(rLo) & " Sätze in `laborxbakt`"
...
Public FUNCTION laborxwertSpeichern(SammelInsert%, BezfSp%)
 ...
 Pid = rNa(0).Pat_id
 ON Error GoTo fehler
 syscmd 4, pid & ": Speichere " & ubound(rLw) & " Sätze in `laborxwert`"
...
Public FUNCTION laborxleistSpeichern(SammelInsert%, BezfSp%)
 ...
 Pid = rNa(0).Pat_id
 ON Error GoTo fehler
 syscmd 4, pid & ": Speichere " & ubound(rLL) & " Sätze in `laborxleist`"
...
Public FUNCTION liuezSpeichern(SammelInsert%, BezfSp%)
 ...
 Pid = rNa(0).Pat_id
 ON Error GoTo fehler
 syscmd 4, pid & ": Speichere " & ubound(rLi) & " Sätze in `liuez`"
