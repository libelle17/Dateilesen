          ...
          Next i
           If Not debugohneSpeichern Then
            ...
            For i = 1 To UBound(rLw2)
             ...
             If rs.BOF Then
              InsKorr DBCn, DBCnS, "INSERT INTO `laborparameter`(`abkü`,`einheit`,`langtext`,`aktzeit`) VALUES('" & rLw2(i).e.Abkü & "','" & rLw2(i).e.Einheit & "','" & rLw2(i).e.Langname & "'," & DatFor_k(Now()) & ")", rAf
             End If
             
             Dim laborid&
             laborid = indIns(DBCn, DBCnS, "laborxplab", "labor", rLs(0).Labor, "id")
             Set rs = Nothing
