...
' in Datei.Lese.los und BriefImport_Click
...
#End If
    ...
    "   AND NOT art IN ('BMI','GEW','GR',342,345,'bd','bla','re','ba','doppler','dop','duplex','impf','inj','kva','tv','ufrag','wv','caro','colo','debr','fa','EKG','GPD','kv','LZRR','OAU','pa','pros','puls','rp','sono','ulcus','vac','ADL'," & artSpezMA & ")" & vbCrLf & _
    "   GROUP BY pat_id,DATE(e.zeitpunkt) " & vbCrLf & _
