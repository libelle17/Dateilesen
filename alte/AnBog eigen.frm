...
Begin VB.Form AnBog 
   ...
   Begin VB.PictureBox picButtons 
      ...
      Top             =   16035
      Width           =   23115
      Begin VB.CommandButton inTurbomed 
         Caption         =   "in &Turbomed öffnen"
         Height          =   255
         Left            =   8400
         TabIndex        =   454
         Top             =   0
...
#Else
 AnwPfad = App.path
#End If
 Select Case MsgBox("FNr: " & FNr & "ErrNr: " & CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " + IIf(IsNull(Err.source), vbNullString, CStr(Err.source)) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "Aufgefangener Fehler in cmdAdd_Click/" + AnwPfad)
...
#Else
 AnwPfad = App.path
#End If
 Select Case MsgBox("FNr: " & FNr & "ErrNr: " & CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " + IIf(IsNull(Err.source), vbNullString, CStr(Err.source)) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "Aufgefangener Fehler in cmdDelete_Click/" + AnwPfad)
  Case vbAbort: Call MsgBox("Höre auf"): Ende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox("Setze fort"): Resume Next
 End Select
...
#Else
 AnwPfad = App.path
#End If
 Select Case MsgBox("FNr: " & FNr & "ErrNr: " & CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " + IIf(IsNull(Err.source), vbNullString, CStr(Err.source)) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "Aufgefangener Fehler in cmdRefresh_Click/" + AnwPfad)
  Case vbAbort: Call MsgBox("Höre auf"): Ende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox("Setze fort"): Resume Next
 End Select
...
#Else
 AnwPfad = App.path
#End If
 Select Case MsgBox("FNr: " & FNr & "ErrNr: " & CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " + IIf(IsNull(Err.source), vbNullString, CStr(Err.source)) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "Aufgefangener Fehler in cmdEdit_Click/" + AnwPfad)
  Case vbAbort: Call MsgBox("Höre auf"): Ende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox("Setze fort"): Resume Next
 End Select
...
#Else
 AnwPfad = App.path
#End If
 Select Case MsgBox("FNr: " & FNr & "ErrNr: " & CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " + IIf(IsNull(Err.source), vbNullString, CStr(Err.source)) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "Aufgefangener Fehler in cmdUpdate_Click/" + AnwPfad)
  Case vbAbort: Call MsgBox("Höre auf"): Ende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox("Setze fort"): Resume Next
 End Select
...
fehler:
 ...
 rs.Open "select pat_id, concat(nachname,' ', vorname) as gesname  from anamnesebogen a where pat_id in (select pat_id from aktf) order by pat_id desc", DBCn, adOpenStatic, adLockReadOnly
...
#Else
 AnwPfad = App.path
#End If
 Select Case MsgBox("FNr: " & FNr & "ErrNr: " & CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " + IIf(IsNull(Err.source), vbNullString, CStr(Err.source)) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "Aufgefangener Fehler in cmdFirst_Click/" + AnwPfad)
  Case vbAbort: Call MsgBox("Höre auf"): Ende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox("Setze fort"): Resume Next
 End Select
...
#Else
 AnwPfad = App.path
#End If
 Select Case MsgBox("FNr: " & FNr & "ErrNr: " & CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " + IIf(IsNull(Err.source), vbNullString, CStr(Err.source)) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "Aufgefangener Fehler in cmdLast_Click/" + AnwPfad)
  Case vbAbort: Call MsgBox("Höre auf"): Ende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox("Setze fort"): Resume Next
 End Select
...
'   Next ctl
'   Set Me.vTextB(160).DataSource = adoRS
   On Error GoTo fehler
'   me.obstumm = True
   If False Then
einzeln:
...
fehler:
 ...
 adoRS.Open "select *,if(größe=0,'',gewicht/größe/größe*if(größe>3,10000,1)) as bmi, concat(nachname,' ', vorname) as gesname  from anamnesebogen where pat_id in (select pat_id from aktf) order by pat_id desc", DBCn, adOpenDynamic, adLockOptimistic ' adLockReadOnly ' 7.9.09
...
#Else
 AnwPfad = App.path
#End If
 Select Case MsgBox("FNr: " & FNr & "ErrNr: " & CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " + IIf(IsNull(Err.source), vbNullString, CStr(Err.source)) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "Aufgefangener Fehler in cmdNext_Click/" + AnwPfad)
  Case vbAbort: Call MsgBox("Höre auf"): Ende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox("Setze fort"): Resume Next
 End Select
...
fehler:
 Dim rs As New ADODB.Recordset
 rs.Open "select pat_id, concat(nachname,' ', vorname) as gesname  from anamnesebogen a where pat_id in (select pat_id from aktf) order by pat_id", DBCn, adOpenStatic, adLockReadOnly
 Do While rs!Pat_id <= adoRS!Pat_id And Not rs.EOF
   rs.MoveNext
 Loop
 If Not rs.EOF Then
...
'  Resume wieder
  ...
  Resume
 End If
 Select Case MsgBox("FNr: " & FNr & "ErrNr: " & CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " + IIf(IsNull(Err.source), vbNullString, CStr(Err.source)) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "Aufgefangener Fehler in cmdPrevious_Click/" + AnwPfad)
  Case vbAbort: Call MsgBox("Höre auf"): Ende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox("Setze fort"): Resume Next
 End Select
...
'   adoRS.MoveFirst
   adoRS.Find " Pat_id >= " & Me.suche, 0, adSearchForward, adBookmarkFirst
...
#Else
 AnwPfad = App.path
#End If
 Select Case MsgBox("FNr: " & FNr & "ErrNr: " & CStr(Err.Number) + vbCrLf + "LastDLLError: " + CStr(Err.LastDllError) + vbCrLf + "Source: " + IIf(IsNull(Err.source), vbNullString, CStr(Err.source)) + vbCrLf + "Description: " + Err.Description, vbAbortRetryIgnore, "Aufgefangener Fehler in Suchen_Click/" + AnwPfad)
  Case vbAbort: Call MsgBox("Höre auf"): Ende
  Case vbRetry: Call MsgBox("Versuche nochmal"): Resume
  Case vbIgnore: Call MsgBox("Setze fort"): Resume Next
 End Select
...
Private Sub vCheckb_MouseMove(Index As Integer, Button As Integer, Shift As Integer, x As Single, Y As Single)
 Dim rs As New ADODB.Recordset
 If LVobMySQL Then
  Call rs.Open("SELECT column_comment FROM information_schema.`COLUMNS` where table_name = 'anamnesebogen' and column_name = '" & Me.vCheckb(Index).DataField & "'", DBCn, adOpenStatic, adLockReadOnly)
  If Not rs.EOF Then
...
Private Sub vCommandB_MouseMove(Index As Integer, Button As Integer, Shift As Integer, x As Single, Y As Single)
 Dim rs As New ADODB.Recordset
 If LVobMySQL Then
  Call rs.Open("SELECT column_comment FROM information_schema.`COLUMNS` where table_name = 'anamnesebogen' and column_name = '" & Me.vCommandB(Index).Name & "'", DBCn, adOpenStatic, adLockReadOnly)
  If Not rs.EOF Then
...
Private Sub vlab_MouseMove(Index As Integer, Button As Integer, Shift As Integer, x As Single, Y As Single)
 Dim rs As New ADODB.Recordset
 If LVobMySQL Then
  Call rs.Open("SELECT column_comment FROM information_schema.`COLUMNS` where table_name = 'anamnesebogen' and column_name = '" & Me.vLab(Index).DataField & "'", DBCn, adOpenStatic, adLockReadOnly)
  If Not rs.EOF Then
...
Private Sub vOptionB_MouseMove(Index As Integer, Button As Integer, Shift As Integer, x As Single, Y As Single)
 Dim rs As New ADODB.Recordset
 If LVobMySQL Then
  Call rs.Open("SELECT column_comment FROM information_schema.`COLUMNS` where table_name = 'anamnesebogen' and column_name = '" & Me.vOptionB(Index).DataField & "'", DBCn, adOpenStatic, adLockReadOnly)
  If Not rs.EOF Then
...
Private Sub vTextB_MouseMove(Index As Integer, Button As Integer, Shift As Integer, x As Single, Y As Single)
 Dim rs As New ADODB.Recordset
 If LVobMySQL Then
  Call rs.Open("SELECT column_comment FROM information_schema.`COLUMNS` where table_name = 'anamnesebogen' and column_name = '" & Me.vTextB(Index).DataField & "'", DBCn, adOpenStatic, adLockReadOnly)
  If Not rs.EOF Then
...
Private Sub Form_MouseMove(Button As Integer, Shift As Integer, x As Single, Y As Single)
 Me.Inhalt = ""
 Me.Inhalt.BackColor = &H8000000F
 Me.Erklärung = ""
 Me.Erklärung.BackColor = &H8000000F
End Sub
